 ...
 * @since       11.1
 */
class JAbstractJ35Menu extends JMenuBase
{
	
}

class JMenu extends JAbstractJ35Menu
{
/**
	...
	public static function getInstance($client, $options = array())
	{
		if (empty(self::$instances[$client]))
		{
			...
			if (!class_exists($classname))
			{
				...
				if (is_object($info))
				{
					//XITODO: CHanged by payplans
					$path = $info->path.DS.'plugins'.DS.'payplans'.DS.'menuaccess'.DS.'menuaccess'.DS.'joomla'.DS.'menu'.DS.'site.php';
					if (file_exists($path))
					{
