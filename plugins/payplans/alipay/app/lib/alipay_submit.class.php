...
class AlipaySubmit
{
	...
	var $alipay_gateway_new_dev = 'https://openapi.alipaydev.com/gateway.do?';
	...
	/**
	 * Generates the form values that is needed
	 *
	 * @since	4.0.0
	 * @access	public
	 */
	public function getFormInputs($para_temp)
	{
		$params = $this->buildRequestPara($para_temp);
		$output = '';
	...
	function buildRequestForm($para_temp, $method, $button_name) {
		...
		$sHtml = $sHtml.'<script>
		(function($){payplans.jQuery(document).ready(function (){
			$("input[name=\''.JSession::getFormToken().'\']").remove();
