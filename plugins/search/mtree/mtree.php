	...
	function onContentSearch( $text, $phrase='', $ordering='', $areas=null )
	{
		...
		switch ($ordering)
		{
			...
			case 'popular':
				...
				$order_cat = 'cat_name DESC'; // fall to alphabetically sorted since category does not nave pageviews
				break;
			case 'alpha':
		...
		$db->setQuery("SELECT id FROM #__menu WHERE link = 'index.php?option=com_mtree&view=home' AND published = 1 LIMIT 1");
