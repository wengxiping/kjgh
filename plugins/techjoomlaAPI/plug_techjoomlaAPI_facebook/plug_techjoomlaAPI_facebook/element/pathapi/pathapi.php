				...
				protected function getInput()
				{
					...
					if($this->id=='jform_params_pathapi_facebook')
						$return	=		'<div class="instructions">
											Go to <a href="http://techjoomla.com/documentation-for-invitex/configuring-facebook-api-plugin.html" target="_blank">How to configure Techjoomla-Facebook API</a><br />
										</div>';
						return $return;
