			...
			class JFormFieldPathapi extends JFormField
			{
				...
				protected function getInput()
				{
					...
					$return	='<div class="instructions">
								Go to <a href="http://techjoomla.com/documentation-for-invitex/configuring-hotmail-api-plugin.html" target="_blank">How to configure Techjoomla-Hotmail API</a><br />
								</div>';
						return $return;
