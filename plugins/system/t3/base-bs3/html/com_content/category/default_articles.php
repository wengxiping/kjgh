...
$doc->addStyleSheet("components/com_jblance/css/customer/new_rule_centre.css");
...
<form action="<?php echo htmlspecialchars(JUri::getInstance()->toString()); ?>" method="post" name="adminForm" id="adminForm" class="form-inline">
	<?php if ($this->params->get('filter_field') !== 'hide' || $this->params->get('show_pagination_limit')) :?>
		<!-- 暂时隐藏 -->
		<fieldset class="filters btn-toolbar clearfix" style='display:none'>
	...
	<div style='text-align: right;display: none;'>
			...
			<div class="xp-pagination" style="margin-top: 56px!important;">
					<div class="serviceListTotal">共<span> <?php echo $this->pagination->total;?> </span>条记录</div>
