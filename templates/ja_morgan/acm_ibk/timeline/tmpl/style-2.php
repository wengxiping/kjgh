...
$array=array();
for ($i=0; $i<$count; $i++) {
	$array[$i] = $helper->get('data.time-line', $i);
}
arsort($array);
$j=0;
?>
      ...
      ?>
        <div class="item-row">
          <div class="timeline-item">
            ...
            <?php if($helper->get('data.time-line', $i)): ?><div class="item-date"><?php echo $helper->get('data.time-line', $i) ?></div><?php endif; ?>
            <div class="item-content">

              <div class="item-body media">
                <?php if($helper->get('data.image', $i)): ?>
                  <img src="<?php echo $helper->get('data.image', $i) ?>" class="media-object pull-left" alt="<?php echo $helper->get('data.title', $i) ?>">
                <?php endif; ?>
                <div class="media-body">
                  <?php if($helper->get('data.title', $i)): ?><a href="#demo"  class="item-title"><?php echo $helper->get('data.title', $i) ?></a><?php endif; ?>
                  <p class="item-ct"><?php echo $helper->get('data.description', $i) ?><br>
