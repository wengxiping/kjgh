...
?>
	<?php foreach($this->items[$this->parent->id] as $id => $item) : ?>
		...
		<div class="category-item<?php echo $class; ?> col-md-6 col">
		<?php $class = ''; ?>
			<div class="category-item-inner">
				...
				<h3 class="page-header item-title">
					...
					<?php if ($this->params->get('show_cat_num_articles_cat') == 1) :?>
						<span class="badge badge-info tip hasTooltip pull-right" title="<?php echo JHtml::_('tooltipText', 'COM_CONTENT_NUM_ITEMS_TIP'); ?>">
