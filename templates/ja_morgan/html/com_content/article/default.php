...
if ($document->countModules('masthead') || $tmpl !== 'component') {
	$masthead = JLayoutHelper::render('joomla.content.masthead', array('params' => $this->params, 'title' => $this->escape($this->item->title), 'print' => $this->print, 'item' => $this->item,'params' => $params, 'imageBg' => $imagesBg));
...
<div class="item-page<?php echo $this->pageclass_sfx; ?>">
	...
	<article>
	  <meta itemscope itemprop="mainEntityOfPage"  itemType="https://schema.org/WebPage" itemid="https://google.com/article"/>
		...
		<?php if (!$document->countModules('masthead') || $tmpl == 'component') : ?>
  	...
  	|| $params->get('show_hits') || $params->get('show_parent_category') || $params->get('show_author') || $assocParam || $icons); ?>
  	...
  	<?php if (!$document->countModules('masthead') || $tmpl == 'component') : ?>
		...
		<?php if ($params->get('access-view')) : ?>
			...
			<!-- Footer -->
			<?php if (($useDefList && $info == 1) || (($params->get('show_modify_date') || $params->get('show_create_date')) && $info == 2)) : ?>
