...
<form action="<?php echo htmlspecialchars(JUri::getInstance()->toString()); ?>" method="post" name="adminForm" id="adminForm" class="form-inline">
	...
	<div class="category" itemscope itemtype="http://schema.org/ItemList">
		<?php foreach ($items as $i => $item) : ?>
			<?php $rowcount = ((int) $i % (int) $column ) + 1; ?>

			<?php if ($rowcount === 1) : ?>
				<?php $row = $counter / $column; ?>
			<div class="cat-list cat-list-row-<?php echo $row; ?> row">
			<?php endif; ?>

				<div class="<?php if ($item->core_state == 0) echo 'system-unpublished '; ?>col-sm-6 col-md-<?php echo 12/$column; ?> item" itemprop="itemListElement" itemscope itemtype="https://schema.org/ListItem">
				...
				<?php else : ?>
				<h3 itemprop="name">
					<a href="<?php echo JRoute::_(TagsHelperRoute::getItemRoute($item->content_item_id, $item->core_alias, $item->core_catid, $item->core_language, $item->type_alias, $item->router)); ?>" itemprop="url" title="<?php echo $this->escape($item->core_title); ?>">
				...
				<?php $counter++; ?>
				<?php if (($rowcount == $column) or ($counter == $n)) : ?>
			</div>
			<!-- end row -->
				<?php endif; ?>
		<?php endforeach; ?>
