...
<div class="contact<?php echo $this->pageclass_sfx?>" itemscope itemtype="http://schema.org/Person">
					...
					<div class="inner">
						...
						<?php if ($this->params->get('show_profile') && $this->contact->user_id && JPluginHelper::isEnabled('user', 'profile')) : ?>
							<div class="profile-user">
								<div class="page-header"><?php echo '<h2>'. JText::_('COM_CONTACT_PROFILE').'</h2>'; ?></div>
	...
	<?php if ($this->params->get('show_profile') && $this->contact->user_id && JPluginHelper::isEnabled('user', 'profile')) : ?>
		...
		<?php endif; ?>
		<?php if ($this->params->get('presentation_style')=='sliders' || $this->params->get('presentation_style')=='tabs'):?>
			<?php echo $this->loadTemplate('profile'); ?>
		<?php endif; ?>
