...
<div id="k2ModuleBox<?php echo $module->id; ?>" class="k2ItemsBlockList k2ItemsBlock<?php if($params->get('moduleclass_sfx')) echo ' '.$params->get('moduleclass_sfx'); ?>">
  ...
  <ul>
    ...
    <li class="<?php echo ($key%2) ? "odd" : "even"; if(count($items)==$key+1) echo ' lastItem'; ?>">
      <div class="row">
  			...
  			<?php if($params->get('itemCommentsCounter') && $componentParams->get('comments')): ?>		
  				...
  				<?php else: ?>
  					<a class="moduleItemComments" href="<?php echo $item->link.'#itemCommentsAnchor'; ?>">
  						<i class="fa fa-comment-o"></i> <?php echo $item->numOfComments; ?>
  					</a>
  				<?php endif; ?>
  			<?php endif; ?>
        ...
        <span class="moduleItemDateCreated"><i class="fa fa-calendar-o"></i> <?php echo JATemplateHelper::relTime($item->created); ?></span>
        <?php endif; ?>
