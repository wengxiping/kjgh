		...
		<ul>
			...
			<li>
				<a class="itemEmailLink" rel="nofollow" href="<?php echo $this->item->emailLink; ?>" onclick="window.open(this.href,'emailWindow','width=400,height=350,location=no,menubar=no,resizable=no,scrollbars=no'); return false;">
					<span><i class="fa fa-envelope-o"></i> <?php echo JText::_('K2_EMAIL'); ?></span>
				</a>
			</li>
			<?php endif; ?>
			...
			<li>
				...
				<?php else: ?>
					...
					<a class="itemCommentsLink k2Anchor" href="<?php echo $this->item->link; ?>#itemCommentsAnchor">
						<i class="fa fa-comments-o"></i> <span><?php echo $this->item->numOfComments; ?></span> <?php echo ($this->item->numOfComments>1) ? JText::_('K2_COMMENTS') : JText::_('K2_COMMENT'); ?>
					</a>
					<?php else: ?>
					<a class="itemCommentsLink k2Anchor" href="<?php echo $this->item->link; ?>#itemCommentsAnchor">
	...
	<?php endif; ?>
	  ...
	  <?php endif; ?>
		...
		<div class="itemContentFooter">
			...
			<!-- Item Hits -->
			<span class="itemHits">
				<i class="fa fa-heart-o"></i> <?php echo $this->item->hits; ?>
			</span>
			<?php endif; ?>
