...
<div id="k2Container" class="itemDirectoryListView userView<?php if($this->params->get('pageclass_sfx')) echo ' '.$this->params->get('pageclass_sfx'); ?>">
	<div class="toolbar">
	...
	<!-- Item list -->
	<div class="userItemList equal-height">
		<?php foreach ($this->items as $item): ?>
		
		<!-- Start K2 Item Layout -->
		<div style="width:33.3%;" class="col userItemView<?php if(!$item->published || ($item->publish_up != $this->nullDate && $item->publish_up > $this->now) || ($item->publish_down != $this->nullDate && $item->publish_down < $this->now)) echo ' userItemViewUnpublished'; ?><?php echo ($item->featured) ? ' userItemIsFeatured' : ''; ?>">
					...
					<div class="userItemCommentsLink">
						...
						<?php else: ?>
							<a href="<?php echo $item->link; ?>#itemCommentsAnchor">
								<i class="fa fa-comment-o"></i> (<?php echo $item->numOfComments; ?>) <?php echo ($item->numOfComments>1) ? JText::_('K2_COMMENTS') : JText::_('K2_COMMENT'); ?>
							</a>
						<?php endif; ?>
					</div>
					<?php endif; ?>
