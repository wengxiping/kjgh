...
<!-- Start K2 Tag Layout -->
<div id="k2Container" class="itemDirectoryListView tagView<?php if($this->params->get('pageclass_sfx')) echo ' '.$this->params->get('pageclass_sfx'); ?>">
	<div class="toolbar">
	...
	<div class="tagItemList equal-height">
		<?php foreach($this->items as $item): ?>

		<!-- Start K2 Item Layout -->
		<div style="width:33.3%;" class="tagItemView col">
