...
<?php if (!empty($this->intro_items)) : ?>
	<?php foreach ($this->intro_items as $key => &$item) : ?>
		...
		<div class="items-row cols-<?php echo (int) $this->columns;?> <?php echo 'row-'.$row; ?> row equal-height equal-height-child">
		<?php endif; ?>
			<div class="column-<?php echo $rowcount;?><?php echo $item->state == 0 ? ' system-unpublished' : null; ?> col-md-<?php echo round((12 / $this->columns));?> col">
			<div class="item">
				<?php
					$this->item = &$item;
					echo $this->loadTemplate('item');
