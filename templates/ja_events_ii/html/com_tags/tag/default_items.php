		...
		<fieldset class="filters btn-toolbar">
			<?php if ($this->params->get('filter_field')) : ?>
				<div class="btn-group">
					...
					<input type="text" name="filter-search" id="filter-search" value="<?php echo $this->escape($this->state->get('list.filter')); ?>" class="pull-left inputbox" onchange="document.adminForm.submit();" title="<?php echo JText::_('COM_TAGS_FILTER_SEARCH_DESC'); ?>" placeholder="<?php echo JText::_('COM_TAGS_TITLE_FILTER_LABEL'); ?>" />
		...
		<ul class="category list-striped list-unstyled">
			<?php foreach ($items as $i => $item) : ?>
				<?php if ($item->core_state == 0) : ?>
					<li class="has-inview clearfix system-unpublished cat-list-row<?php echo $i % 2; ?>">
				<?php else : ?>
					<li class="has-inview clearfix cat-list-row<?php echo $i % 2; ?> clearfix">
				<?php endif; ?>
