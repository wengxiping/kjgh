...
function JAgetFromattedPrice($price, $curr = null)
{
    $curr_sym                   = JAgetCurrencySymbol();
...
function JAgetCurrencySymbol($currency = '')
{
    $params   = JComponentHelper::getParams('com_jticketing');
		...
		<div class="techjoomla-bootstrap">
			...
			<div class="table-responsive">
				...
				<tr >
					...
					<td align="center">
							<?php  echo JAgetFromattedPrice( number_format(($data->amount),2),$currency);?>
						</td>
						<td align="center">
							<?php  echo JAgetFromattedPrice( number_format(($data->totalamount),2),$currency);?>
						</td>
