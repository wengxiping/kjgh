			...
			<div class="controls">
				<?php if (!$params->get('usetext')) : ?>
					<div class="input-prepend">
						<span class="add-on">
							<span class="hasTooltip" title="<?php echo JText::_('MOD_LOGIN_VALUE_USERNAME') ?>"><i class="fa fa-user"></i></span>
		...
		<div id="form-login-password" class="control-group">
			<div class="controls">
				<?php if (!$params->get('usetext')) : ?>
					<div class="input-prepend">
						<span class="add-on">
							<span class="hasTooltip" title="<?php echo JText::_('JGLOBAL_PASSWORD') ?>"><i class="fa fa-lock"></i></span>
