...
$articleField = new JRegistry($this->item->attribs);
...
<div class="item-page speaker-detail <?php echo $this->pageclass_sfx; ?>" itemscope itemtype="https://schema.org/Article">
	  ...
	  <meta itemscope itemprop="mainEntityOfPage"  itemType="https://schema.org/WebPage" itemid="https://google.com/article"/>
		...
		<?php if ($params->get('access-view')) : ?>
			...
			<section class="article-content clearfix" itemprop="articleBody">
		      ...
		      <div class="addthis_inline_follow_toolbox_hay2"></div>
				</div>
