...
<div class="profile-edit<?php echo $this->pageclass_sfx; ?>">
	...
	<?php endif; ?>
		...
		<div class="form-group form-actions">
			<div class="col-md-12">
				<button type="submit" class="btn btn-lg btn-linear validate"><span><?php echo JText::_('JSUBMIT'); ?></span></button>
				<a class="btn btn-lg btn-light" href="<?php echo JRoute::_('index.php?option=com_users&view=profile'); ?>" title="<?php echo JText::_('JCANCEL'); ?>"><?php echo JText::_('JCANCEL'); ?></a>
