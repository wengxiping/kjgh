...
function modChrome_T3Xhtml($module, &$params, &$attribs) { 
	...
	if (!empty ($module->content)) {
		$html = "<{$moduleTag} class=\"t3-module module{$moduleClassSfx} {$moduleClass}\" id=\"Mod{$module->id}\" data-paroller-factor=\"-0.15\" data-paroller-type=\"foreground\">" .
...
function modChrome_T3Section($module, &$params, &$attribs) { 
	...
	if (!empty ($module->content)) {
		$html = "<{$moduleTag} class=\"t3-section {$moduleClassSfx} {$moduleClass} \" id=\"Mod{$module->id}\"><div class=\"container\">";
