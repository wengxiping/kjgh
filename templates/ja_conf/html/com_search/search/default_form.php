...
<form id="searchForm" action="<?php echo JRoute::_('index.php?option=com_search'); ?>" method="post">
	...
	<div class="input-group form-group clearfix">
		<input aria-label="<?php echo JText::_('COM_SEARCH_SEARCH_KEYWORD'); ?>" type="text" name="searchword" placeholder="<?php echo JText::_('COM_SEARCH_SEARCH_KEYWORD'); ?>"
		...
		<span class="input-group-btn">
			<button aria-label="<?php echo JText::_('COM_SEARCH_SEARCH'); ?>" name="Search" onclick="this.form.submit()" class="btn btn-linear"
