...
?>
<div id="es" class="es es-frontend mod-es mod-es-dropdown-menu <?php echo $lib->getSuffix();?>">
	<?php if ($lib->my->id) { ?>
	<div class="dropdown_">
	    <div class="btn btn-es-default-o btn-block dropdown-toggle_ fd-cf" data-bs-toggle="dropdown">
	        <div class="o-flag o-flag--rev">
                <div class="o-flag__image">
                    <div class="o-avatar o-avatar--xsm">
                        <img src="<?php echo $lib->my->getAvatar();?>" />
                    </div>
                </div>
	    ...
	    <ul class="dropdown-menu dropdown-menu-user dropdown-menu-full">
	...
	<?php } else { ?>
		<a href="javascript:void(0);" class="btn btn-es-primary btn-sm"
                ...
                <div class="popbox-dropdown__bd">
                    <form action="<?php echo JRoute::_('index.php');?>" method="post" class="popbox-dropdown-signin">
                        <div class="o-form-group">
                            <input name="username" type="text" autocomplete="off"  class="o-form-control" id="es-username" placeholder="<?php echo JText::_($loginPlaceholder); ?>" />
                        </div>
                        <div class="o-form-group">
                        ...
                        <div class="o-row">
                            <div class="o-col o-col--8" <?php echo $showRememberMe ? '' : 'style="display: none;"'; ?>>
                                <div class="o-checkbox o-checkbox--sm">
                                    <input type="checkbox" id="es-remember" name="remember" <?php echo $checkRememberMe ? 'checked="checked"' : ''; ?> />
