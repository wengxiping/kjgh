...
?>
<?php if( !$my->id ){ ?>
<div id="es" class="es es-frontend mod-es-login style-vertical module-social<?php echo $lib->getSuffix();?>">
	<form class="es-form-login" method="post" action="<?php echo JRoute::_('index.php', true, $lib->useSecureUrl());?>">
		...
		<ul class="o-nav o-nav--stacked t-lg-mt--xl">
			...
			<li>
				<a href="<?php echo ESR::registration();?>"><span class="fa fa-user-plus"></span></a>
			</li>
			<?php } ?>
			...
			<li>
				<a href="<?php echo ESR::account(array('layout' => 'forgetUsername'));?>"><span class="fa fa-user"></span></a>
			</li>
			<?php } ?>
			
			<?php if ($params->get('show_forget_password', true)) { ?>
			<li>
				<a href="<?php echo ESR::account(array('layout' => 'forgetPassword'));?>"><span class="fa fa-key"></span></a>
			</li>
			<?php } ?>
		</ul>
...
<div id="es" class="es mod-es-login style-vertical module-social<?php echo $lib->getSuffix();?>">
	<form action="<?php echo JRoute::_('index.php');?>" id="es-mod-login-signout-form" method="post">
		<div class="text-center">
			<a href="javascript:void(0);" onclick="document.getElementById('es-mod-login-signout-form').submit();" class="btn btn-es-primary btn-block">
				<i class="fas fa-sign-out-alt"></i>&nbsp; <?php echo JText::_('MOD_EASYSOCIAL_LOGIN_SIGN_OUT');?>
			</a>
		</div>
