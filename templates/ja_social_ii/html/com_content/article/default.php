...
<?php	if ($params->get('access-view')): ?>
  ...
  <!-- footer -->
  <?php if (($params->get('show_tags', 1) && (count($this->item->tags->itemTags)>=1) ) || $botInfo || ($params->get('show_noauth') == true &&  $user->get('guest')) && ($params->get('show_readmore') && $this->item->fulltext != null) || (!empty($this->item->pagination) && $this->item->pagination && $this->item->paginationposition && !$this->item->paginationrelative)) : ?>
  <footer class="article-footer clearfix">
    <?php echo JLayoutHelper::render('joomla.content.info_block.block', array('item' => $this->item, 'params' => $params, 'position' => 'below')); ?>
    <?php if ($params->get('show_tags', 1) && !empty($this->item->tags)) : ?>
      <?php echo JLayoutHelper::render('joomla.content.tags', $this->item->tags->itemTags); ?>
    <?php endif; ?>
    <?php if ($params->get('show_readmore') && $this->item->fulltext != null && $params->get('show_noauth') == true &&  $user->get('guest')) :
