...
<dd class="createdby" itemprop="author": _ itemtype="http://schema.org/Person" title="<?php echo JText::sprintf('COM_CONTENT_WRITTEN_BY', ''); ?>">
  <span itemprop="name"><?php echo JText::sprintf('TPL_COM_CONTENT_WRITTEN_BY', ''); ?></span>
