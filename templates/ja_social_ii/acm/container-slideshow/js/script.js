...
(function($){
	...
	$(document).ready(function() {
		...
		if($('.acm-features.style-3 .content-left').length > 0) {
			$('.acm-container-slide.slide-1').addClass('ft-left');
		}
		
		if($('.acm-features.style-3 .content-right').length > 0) {
			$('.acm-container-slide .content-right').each(function() {
				var ctr = $(this).parents('.acm-container-slide.slide-1:first');
