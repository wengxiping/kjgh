...
?>
<div class="ja-masthead<?php echo $params->get('moduleclass_sfx','')?>" <?php if ($mh_background && $mh_background->type == 'image') : ?>style=""<?php endif; ?>>
	<img class="new-bg-img" src="<?php echo $mh_background->url; ?>">
    <?php
        // Video backround
