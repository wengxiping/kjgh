 ...
 * @file name	:	modules/mod_jblancemenu/helper.php
...
class ModJblanceMenuHelper {
     ...
     * @return  array
     */
    public static function getList(&$params, $menutype){
        ...
        $cache = JFactory::getCache('mod_jblancemenu', '');
    ...
    public static function countUnreadFeeds(){
    	$db = JFactory::getDbo();
    	$user	= JFactory::getUser();
                ...
                foreach ($list as $list_index => $subitem) {
                    ...
                    if ($subitem->parent_id == $item->id && $this->Is_Joomla_Item_New($subitem, 'sub_menu')) {
                        ...
                        if ($subitem->parent) {
                            ...
                            $menu_item[] = $this->Create_BootStrap_Menu_Item($subitem, '', $subnav_class);
