...
<ul class="nav menu<?php echo $class_sfx; ?>">
	...
	if ($show['browsebytag']): ?>
	<li<?php echo ($active == 'browseby') ? ' class="parent active"' : ''; ?>><a href="<?php echo JRoute::_("index.php?option=com_mtree&task=searchby&cat_id=".$toplist_cat_id.$itemid); ?>"><?php echo JText::_( 'MOD_MT_MENU_BROWSE_BY_TAG' ); ?></a></li>
	<?php endif;
	...
	if ($show['randomlisting']): ?>
	<li<?php echo ($active == 'listrandom') ? ' class="parent active"' : ''; ?>><a href="<?php echo JRoute::_("index.php?option=com_mtree&task=listrandom&cat_id=".$toplist_cat_id.$itemid); ?>"><?php echo JText::_( 'MOD_MT_MENU_RANDOM_LISTING' ); ?></a></li>
	<?php endif;

	if ($show['listingowners']): ?>
	<li<?php echo ($active == 'owner') ? ' class="parent active"' : ''; ?>><a href="<?php echo JRoute::_("index.php?option=com_mtree&task=owner".$itemid); ?>"><?php echo JText::_( 'MOD_MT_MENU_LISTING_OWNERS' ); ?></a></li>
	<?php endif;

	if ($show['advancedsearch']): ?>
	<li<?php echo ($active == 'advsearch') ? ' class="parent active"' : ''; ?>><a href="<?php echo JRoute::_("index.php?option=com_mtree&task=advsearch&cat_id=".$toplist_cat_id.$itemid); ?>"><?php echo JText::_( 'MOD_MT_MENU_ADVANCED_SEARCH' ); ?></a></li>
	<?php endif; ?>
</ul>