...
$show['browsebytag']	= $params->get( 'show_browsebytag', 1 );
...
$show['randomlisting']	= $params->get( 'show_randomlisting', 1 );
$show['listingowners']	= $params->get( 'show_listingowners', 1 );
$show['advancedsearch']	= $params->get( 'show_advancedsearch', 1 );
...
require JModuleHelper::getLayoutPath('mod_mt_menu', $params->get('layout', 'default'));
