...
<form method="post" name="eb_search_form" id="eb_search_form" action="<?php echo JRoute::_('index.php?option=com_eventbooking&task=search&&Itemid='.$itemId);  ?>" class="form">
    ...
    ?>
        <div class="<?php echo $controlGroupClass; ?>">
            ...
            <div class="<?php echo $controlsClass; ?>"><?php echo JHtml::_('calendar', $fromDate, 'filter_from_date', 'filter_from_date', $datePickerFormat, ['class' => 'input-medium']); ?></div>
        </div>
    <?php
    }
    ...
    ?>
        <div class="<?php echo $controlGroupClass; ?>">
            ...
            <div class="<?php echo $controlsClass; ?>"><?php echo JHtml::_('calendar', $toDate, 'filter_to_date', 'filter_to_date', $datePickerFormat, ['class' => 'input-medium']); ?></div>
        </div>
    <?php
    }
