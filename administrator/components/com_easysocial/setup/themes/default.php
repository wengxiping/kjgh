		...
		<div class="container">
			<div class="top-bar row-table">
				<div class="col-cell">
					<div class="row-table">
						<div class="col-cell">
							<img src="<?php echo ES_SETUP_URL;?>/assets/images/logo.png" height="48" width="48" />
						</div>
						<div class="col-cell text-left">
							<h3><?php echo JText::_('EasySocial');?></h3>
							<span><?php echo JText::_('Building Awesome Social Network for Joomla!');?></span>
						</div>
					</div>
				</div>
				<div class="col-cell">
					<a class="btn btn-support" href="https://stackideas.com/forums" target="_blank">
						<img src="<?php echo ES_SETUP_URL;?>/assets/images/support-color.svg" width="24" height="24" alt="Support" />
						&nbsp;<span>Need help?</span>
					</a>
				</div>
			</div>
