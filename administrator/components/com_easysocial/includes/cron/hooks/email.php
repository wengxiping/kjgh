...
class SocialCronHooksEmail extends EasySocial
{
	 ...
	 * @access	public
	 */
	public function dispatchEmails($limit = null)
	{
		if (is_null($limit)) {
			$limit = (int) $this->config->get('email.cron.total', 20);
		}
