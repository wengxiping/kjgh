...
<ul id="userForm" class="nav nav-tabs nav-tabs-icons" data-es-form-tabs>
	...
	<li class="tabItem<?php echo $activeTab == 'header' ? ' active' : '';?>">
		<a data-bs-toggle="tab" href="#header" data-item="header">
			<span class="help-block"><?php echo JText::_('COM_ES_CLUSTERS_HEADER_TAB');?></span>
		</a>
	</li>
	<?php } ?>
</ul>
