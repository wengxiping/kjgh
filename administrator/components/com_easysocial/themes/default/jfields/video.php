...
<span class="input-append">
	...
	<a href="javascript:void(0);" class="btn btn-default" data-jfield-video>
		<i class="icon-video-2"></i> <?php echo JText::_('COM_ES_SELECT'); ?>
	</a>
	<a href="javascript:void(0);" class="btn btn-default" data-jfield-video-remove>
