...
<dialog>
	...
	<title><?php echo JText::_('COM_EASYSOCIAL_PAGES_SWITCH_CATEGORY_DIALOG_TITLE'); ?></title>
	<content>
		<div class="clearfix">
			<form name="switchCategory" method="post" action="index.php" data-switch-category-form>
			<p>
				<?php echo JText::_('COM_EASYSOCIAL_PAGES_SWITCH_CATEGORY_DIALOG_DESC');?>
			</p>

			<div class="form-group">
				<label for="total" class="col-md-3 t-fs--sm"><?php echo JText::_('COM_EASYSOCIAL_PAGES_SELECT_CATEGORY');?></label>
				<div class="col-md-9">
					<select class="o-form-control input-sm" autocomplete="off" name="category" id="category">
			...
			<div>
				...
				<br /><?php echo JText::_('COM_EASYSOCIAL_PAGES_SWITCH_CATEGORY_DIALOG_FOOTNOTE');?>
			</div>
