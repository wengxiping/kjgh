			...
			<div class="cell grid-x acym__campaign__summary__generated__list acym_vcenter margin-bottom-2">
				...
				<div class="cell auto grid-x grid-margin-x grid-margin-y">
                    <?php foreach ($data['lists'] as $list) { ?>
						<div class="cell shrink acym__campaign__summary__generated__list__tag"><i class="fa fa-circle" style="color: <?php echo $list->color ?>;"></i><?php echo $list->name; ?></div>
                    <?php } ?>
				</div>
			</div>
			<div class="cell grid-x acym__campaign__summary__generated__mail">
				...
				<div class="cell grid-x acym__campaign__summary__generated__mail__one">
					...
					<div class="cell grid-x acym__campaign__summary__generated__mail__preview">
						<i class="fa fa-unsorted acym__campaign__summary__generated__mail__toogle__preview"></i>
			...
			<div class="cell text-right grid-margin-y acym__campaign__summary__generated__action grid-margin-x margin-top-2 grid-x">
				...
				<div class="cell medium-auto align-right grid-margin-x acym_vcenter">
                    ...
                    <?php } elseif ($data['campaign']->waiting_confirmation) { ?>
						<button type="button" class="cell shrink button button-cancel acy_button_submit" data-task="disableGeneratedCampaign"><?php echo acym_translation('ACYM_DISABLE'); ?> <i class="fa fa-lock"></i></button>
						<button type="button" class="cell shrink button button-send acy_button_submit" data-task="addQueue"><?php echo acym_translation('ACYM_SEND'); ?> <i class="fa fa-paper-plane"></i></button>
                    <?php } else { ?>
						<button type="button" class="cell shrink button acy_button_submit" data-task="enableGeneratedCampaign"><?php echo acym_translation('ACYM_ENABLE'); ?> <i class="fa fa-unlock"></i></button>
						<button type="button" class="cell shrink disabled button button-send" disabled><?php echo acym_translation('ACYM_SEND'); ?> <i class="fa fa-paper-plane"></i></button>
                    <?php } ?>
				</div>
			</div>
		</div>
