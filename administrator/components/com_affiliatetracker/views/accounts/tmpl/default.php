  ...
  <div id="j-main-container" >
    ...
    <table class="table table-striped">
      <thead>
        <tr>
          ...
          <th align="right" class="hidden-phone width55"><?php echo JText::_('AFFILIATE_PARENT_TH'); ?></th>
    ...
    $link_user    = JRoute::_( 'index.php?option=com_affiliatetracker&controller=accounts&user_id='. $row->user_id );
      ...
      <tr class="<?php echo "row$k"; ?>">
        ...
        <td align="right" class="hidden-phone"><?php echo AffiliateHelper::getParentUsernameFromParentId($row->parent_id); ?></td>
