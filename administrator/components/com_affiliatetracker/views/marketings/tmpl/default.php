...
<form action="index.php" method="post" name="adminForm" id="adminForm" class="form-horizontal">
    <div id="j-main-container" >
        ...
        <table class="table table-striped">
            <thead>
            <tr>
                <th width="5" class="hidden-phone"> <?php echo JHTML::_( 'grid.sort', 'ID', 'mm.id', $this->lists['order_Dir'], $this->lists['order']); ?> </th>
                ...
                <th width="5" class="hidden-phone"><?php echo JHTML::_( 'grid.sort', 'PUBLISHED', 'mm.publish', $this->lists['order_Dir'], $this->lists['order']); ?></th>
            </tr>
            </thead>
            <?php
            $k = 0;
