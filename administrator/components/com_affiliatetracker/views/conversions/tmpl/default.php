  ...
  <div id="j-main-container" >
    <div class="navbar filter-bar">
      <div class="navbar-inner">
        ...
        <input type="text" name="target_user_id" id="target_user_id" value="<?php echo $this->target_user_id;?>" class="input-mini" placeholder="<?php echo JText::_( 'TARGET_USER_ID' ); ?>" />
        ...
        <button class="btn" type="button" onclick="document.getElementById('keywords').value='';document.getElementById('account_id').value='';document.getElementById('user_id').value='';document.getElementById('target_user_id').value='';document.getElementById('status_id').selectedIndex = 0;document.getElementById('cal_start').value='';document.getElementById('cal_end').value='';document.getElementById('adminForm').submit();" title="<?php echo JText::_('RESET'); ?>"><i class="icon-remove"></i></button>
      </div>
    </div>
