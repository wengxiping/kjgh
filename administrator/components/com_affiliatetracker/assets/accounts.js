...
window.addEvent('domready', function(){
	...
	jQuery( "#button_reset_user_parent" ).click(function(e) {
		jQuery('#parent_username').val('');
...
function search_user_parents() {
	var url = "index.php?option=com_affiliatetracker&controller=conversion&task=search_affiliate&searchword=" + jQuery('#search_user_parent').val() + "&parents=1";
