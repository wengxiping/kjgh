...
class PPMaintenanceScriptRenameEasyDiscussApps extends PPMaintenanceScript
{
	public static $title = "Renaming EasyDiscuss apps name";
	public static $description = "Renaming EasyDiscuss apps name to follow the new name standard.";
	...
	public function main()
	{
		...
		$app = new stdClass();
		$app->old = 'edbadges';
		$app->new = 'easydiscussbadges';

		// old structure
		// plugins/payplans/easydiscuss/easydiscuss/apps

		// new structure
		// plugins/payplans/easydiscuss/apps

		// check if older folder exists or not.
		$path = JPATH_ROOT . '/plugins/payplans/easydiscuss/easydiscuss';
