...
class PayplansControllerInstallSync extends PayplansSetupController
{
	...
	public function execute()
	{
		...
		if (!empty($affected)) {
			$this->setInfo(JText::sprintf('COM_PP_INSTALLATION_MAINTENANCE_DB_SYNCED', $version));
		} else {
			$this->setInfo(JText::sprintf('COM_PP_INSTALLATION_MAINTENANCE_DB_NOTHING_TO_SYNC', $version));
		}
