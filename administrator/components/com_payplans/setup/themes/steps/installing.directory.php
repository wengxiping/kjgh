	...
	<div data-install-progress>
		...
		<ol class="install-logs list-reset" data-progress-logs="">
			<li class="active" data-progress-extract>
				...
				<div class="split__title"><?php echo JText::_('COM_PP_INSTALLATION_INSTALLING_EXTRACTING_FILES');?></div>
				<span class="progress-state text-info"><?php echo JText::_('COM_PP_INSTALLATION_INSTALLING_EXTRACTING');?></span>
			</li>
