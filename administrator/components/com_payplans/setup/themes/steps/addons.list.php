		...
		<li>
			...
			<?php if ($data->plugins) { ?>
				...
				<li style="display:none;">
					<div class="checkbox">
						<input type="checkbox" id="plugin-<?php echo $plugin->group . '-' . $plugin->element; ?>" value="<?php echo $plugin->element;?>" data-group="<?php echo $plugin->group;?>" <?php echo $plugin->checked ? 'checked="checked"' : '' ?> data-checkbox data-checkbox-plugin <?php echo $plugin->disabled ? 'disabled':''; ?>/>
