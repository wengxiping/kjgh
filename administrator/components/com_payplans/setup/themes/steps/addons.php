...
<form name="installation" data-installation-form>
	...
	<p class="section-desc"><?php echo JText::_('COM_PP_INSTALLATION_ADDONS_DESC'); ?></p>

	<div data-addons-retrieving style="margin-top:30px;"><?php echo JText::_('COM_PP_INSTALLATION_ADDONS_RETRIEVING_LIST');?></div>

	<div class="hide" style="margin-top: 30px;" data-addons-progress>
		<div class="install-progress" style="border-bottom: 1px #ddd;">
			<div class="row-table">
				<div class="col-cell">
					<div class="hide" data-progress-complete-message><?php echo JText::_('COM_PP_INSTALLATION_MODULE_AND_PLUGINS_COMPLETED');?></div>
					<div data-progress-active-message=""><?php echo JText::_('COM_PP_INSTALLATION_INSTALLING_MODULES');?></div>
				</div>
	...
	<div class="hide" style="margin-top: 30px;" data-sync-progress>
		...
		<div class="install-progress" style="border-bottom: 1px #ddd;">
			...
			<div class="row-table">
				<div class="col-cell">
					<div class="hide" data-sync-progress-complete-message><?php echo JText::_('COM_PP_INSTALLATION_MAINTENANCE_EXEC_SCRIPTS_SUCCESS');?></div>
					<div data-sync-progress-active-message=""><?php echo JText::_('COM_PP_INSTALLATION_MAINTENANCE_EXEC_SCRIPTS');?></div>
				</div>
				<div class="col-cell cell-result text-right">
