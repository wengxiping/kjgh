CREATE TABLE IF NOT EXISTS `#__jblance_bid` (
  ...
  `p_percent` int(11) NOT NULL DEFAULT '0',
  `p_started` datetime NOT NULL DEFAULT '0000-00-00 00:00:00',
  `p_updated` datetime NOT NULL DEFAULT '0000-00-00 00:00:00',
  `p_ended` datetime NOT NULL DEFAULT '0000-00-00 00:00:00',
  `profit_perbid` float NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
...
CREATE TABLE IF NOT EXISTS `#__jblance_budget` (
  ...
  `project_type` varchar(32) NOT NULL DEFAULT 'COM_JBLANCE_FIXED',
  PRIMARY KEY (`id`)
) DEFAULT CHARSET=utf8;
...
CREATE TABLE IF NOT EXISTS `#__jblance_deposit` (
  ...
  `tax_percent_dep` float NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`)
) DEFAULT CHARSET=utf8;
...
CREATE TABLE IF NOT EXISTS `#__jblance_escrow` (
  ...
  `pay_for` int(11) NOT NULL DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `#__jblance_paymode` (
  ...
  `withdrawFeeFixed` float DEFAULT '0',
  `withdrawDesc` varchar(500) DEFAULT NULL,
  `depositfeeFixed` float DEFAULT '0',
  `depositfeePerc` float DEFAULT '0',
  `params` longtext,
  `withdrawFeePerc` float NOT NULL DEFAULT '0',
  `is_subscription` tinyint(1) NOT NULL DEFAULT '1',
...
CREATE TABLE IF NOT EXISTS `#__jblance_plan` (
  ...
  `option_params` mediumtext NOT NULL,
...
CREATE TABLE IF NOT EXISTS `#__jblance_project` (
  ...
  `id_category` varchar(250) NOT NULL,
  `start_date` datetime NOT NULL DEFAULT '0000-00-00 00:00:00',
  ...
  `params` longtext NOT NULL,
  `is_private_invite` tinyint(1) NOT NULL DEFAULT '0',
  `invite_user_id` varchar(500) NOT NULL DEFAULT '0',
  `id_location` int(11) NOT NULL DEFAULT '0',
  `project_image` text NOT NULL,
  `profit_perproject` float NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`)
) DEFAULT CHARSET=utf8;
...
CREATE TABLE IF NOT EXISTS `#__jblance_rating` (
  ...
  `type` varchar(50) NOT NULL DEFAULT 'COM_JBLANCE_PROJECT',
  PRIMARY KEY (`id`)
) DEFAULT CHARSET=utf8;
...
CREATE TABLE IF NOT EXISTS `#__jblance_service` (
  ...
  `profit_perservice` float NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`)
) DEFAULT CHARSET=utf8;
...
CREATE TABLE IF NOT EXISTS `#__jblance_withdraw` (
  ...
  `amount` float NOT NULL,
  `withdrawFeeFixed` float NOT NULL,
