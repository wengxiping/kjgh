...
Joomla.submitbutton = function(task){
	isFormValid = document.formvalidator.isValid(document.getElementById('editproject-form'));
	
	if(task == 'admproject.cancelproject' || (isFormValid)){
...
<form action="index.php" method="post" name="adminForm" id="editproject-form" enctype="multipart/form-data" class="form-validate" novalidate>
	...
	<?php echo JHtml::_('bootstrap.addTab', 'myTab', 'projectinfo', JText::_('COM_JBLANCE_PROJECT_INFORMATION', true)); ?>
		<div class="row-fluid">
				...
				<fieldset>
					...
					<div class="control-group">
						...
						<div class="controls">						
							...
							<?php 
							$attribs = "class='input-xlarge required' size='5' MULTIPLE";
			...
			<div class="span6">
				<fieldset>
					<legend><?php echo JText::_('COM_JBLANCE_PROJECT_IMAGES'); ?></legend>
				...
				<table class="table table-striped table-bordered">
					...
					<tbody>
						...
						<tr id="tr_r2_bid_<?php echo $bid->id; ?>" class="<?php echo "row$k"; ?>">
							...
							<td  class="center">
								<a class="remFeed btn btn-micro" onclick="processBid('<?php echo $bid->id; ?>', 'admproject.processBid');" href="javascript:void(0);" title="<?php echo JText::_('COM_JBLANCE_REMOVE'); ?>"><i class="icon-unpublish"></i></a>
							</td>
						</tr>
						<?php 
							$k = 1 - $k;
	...
	<?php echo JHtml::_('bootstrap.addTab', 'myTab', 'forum', JText::_('COM_JBLANCE_PUBLIC_CLARIFICATION_BOARD', true)); ?>
		<div class="row-fluid">
			<div class="span8">
				<div style="max-height: 600px; overflow: auto;">
					...
					<tbody>
						...
						<tr id="tr_forum_<?php echo $forum->id; ?>">
							...
							<td class="center">
								<a class="remFeed btn btn-micro" onclick="processForum('<?php echo $forum->id; ?>', 'admproject.removeForum');" href="javascript:void(0);" title="<?php echo JText::_('COM_JBLANCE_REMOVE'); ?>"><i class="icon-unpublish"></i></a>
							</td>
						</tr>
						<?php } ?>
					</tbody>
