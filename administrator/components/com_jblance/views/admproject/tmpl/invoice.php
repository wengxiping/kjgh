...
?>
	...
	<?php 
	if($type == 'deposit')
		echo JLayoutHelper::render('invoice.deposit', $this->row, '', array('client' => 0));
	elseif($type == 'withdraw')
		echo JLayoutHelper::render('invoice.withdraw', $this->row, '', array('client' => 0)); 
	elseif($type == 'plan')
		echo JLayoutHelper::render('invoice.plan', $this->row, '', array('client' => 0)); 
	elseif($type == 'project')
		echo JLayoutHelper::render('invoice.project', array('display' => $this->row, 'escrow' => $this->escrows), '', array('client' => 0)); 
	elseif($type == 'service')
		echo JLayoutHelper::render('invoice.service', array('display' => $this->row, 'escrow' => $this->escrows), '', array('client' => 0)); 
	?>
