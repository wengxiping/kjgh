...
<div id="j-main-container" class="span10">
	...
	if($usersConfig->get('allowUserRegistration') == '0'){
		$link_dashboard = 'index.php?option=com_jblance&view=admproject&layout=dashboard';
		...
		<div class="span7">
			<div class="well well-small white">
				...
				<div id="dashboard-icons" class="btn-group">
					<a class="btn" href="<?php echo $link_project; ?>">
						<i class="icon-big icon-list-view"></i><br/>
						<span class="title"><?php echo JText::_('COM_JBLANCE_TITLE_PROJECTS') ?></span>
						<?php echo ($this->unappProjs > 0) ? '<span class="update-badge">'.$this->unappProjs.'</span>' : ''; ?>
					</a>
					<a class="btn" href="<?php echo $link_service; ?>">
						<i class="icon-big icon-paragraph-justify"></i><br/>
						<span class="title"><?php echo JText::_('COM_JBLANCE_TITLE_SERVICES') ?></span>
						<?php echo ($this->unappSvcs > 0) ? '<span class="update-badge">'.$this->unappSvcs.'</span>' : ''; ?>
					</a>
					<a class="btn" href="<?php echo $link_user; ?>">
						<i class="icon-big icon-users"></i><br/>
						<span class="title"><?php echo JText::_('COM_JBLANCE_TITLE_USERS') ?></span>
						<?php echo ($this->unappUsers > 0) ? '<span class="update-badge">'.$this->unappUsers.'</span>' : ''; ?>
					</a>
					<a class="btn" href="<?php echo $link_subscr; ?>">
						<i class="icon-big icon-bookmark"></i><br/>
						<span class="title"><?php echo JText::_('COM_JBLANCE_TITLE_SUBSCRIPTIONS') ?></span>
						<?php echo ($this->unappSubs > 0) ? '<span class="update-badge">'.$this->unappSubs.'</span>' : ''; ?>
					</a>
					<a class="btn" href="<?php echo $link_deposit; ?>">
						<i class="icon-big icon-download"></i><br/>
						<span class="title"><?php echo JText::_('COM_JBLANCE_TITLE_DEPOSITS') ?></span>
						<?php echo ($this->unappDepo > 0) ? '<span class="update-badge">'.$this->unappDepo.'</span>' : ''; ?>
					</a>
					<a class="btn" href="<?php echo $link_withdraw; ?>">
						<i class="icon-big icon-upload"></i><br/>
						<span class="title"><?php echo JText::_('COM_JBLANCE_TITLE_WITHDRAWALS') ?></span>
						<?php echo ($this->unappWdraws > 0) ? '<span class="update-badge">'.$this->unappWdraws.'</span>' : ''; ?>
					</a>
					<a class="btn" href="<?php echo $link_escrow; ?>">
						<i class="icon-big icon-loop"></i><br/>
						<span class="title"><?php echo JText::_('COM_JBLANCE_TITLE_ESCROWS') ?></span>
					</a>
					<a class="btn" href="<?php echo $link_reporting; ?>">
						<i class="icon-big icon-notification"></i><br/>
						<span class="title"><?php echo JText::_('COM_JBLANCE_TITLE_REPORTINGS') ?></span>
					</a>
					<a class="btn" href="<?php echo $link_messages; ?>">
						<i class="icon-big icon-mail"></i><br/>
						<span class="title"><?php echo JText::_('COM_JBLANCE_TITLE_PRIVATE_MESSAGES') ?></span>
						<?php echo ($this->unappMsgs > 0) ? '<span class="update-badge">'.$this->unappMsgs.'</span>' : ''; ?>
					</a>
					<a class="btn" href="<?php echo $link_config; ?>">
						<i class="icon-big icon-cogs"></i><br/>
						<span class="title"><?php echo JText::_('COM_JBLANCE_TITLE_CONFIGURATION') ?></span>
					</a>
					<a class="btn" href="<?php echo $link_summary; ?>">
						<i class="icon-big icon-file-2"></i><br/>
						<span class="title"><?php echo JText::_('COM_JBLANCE_TITLE_SUMMARY') ?></span>
					</a>
					<a class="btn" href="<?php echo $link_custom_field; ?>">
						<i class="icon-big icon-list-2"></i><br/>
						<span class="title"><?php echo JText::_('COM_JBLANCE_CUSTOM_FIELDS') ?></span>
					</a>
					<a class="btn" href="<?php echo $link_about; ?>">
						<i class="icon-big icon-info"></i><br/>
						<span class="title"><?php echo JText::_('COM_JBLANCE_TITLE_ABOUT') ?></span>
					</a>
					<a class="btn" href="<?php echo $link_support; ?>">
						<i class="icon-big icon-help"></i><br/>
						<span class="title"><?php echo JText::_('COM_JBLANCE_SUPPORT') ?></span>
					</a>
				</div>
			</div>
		</div>
