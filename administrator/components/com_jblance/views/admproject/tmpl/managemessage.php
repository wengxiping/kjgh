...
function showtextarea(msgid){
	jQuery("#span_message_"+msgid).css("display","none");
	jQuery("#btn_save_message_"+msgid).css("display","inline");
	jQuery("#btn_edit_message_"+msgid).css("display","none");
	jQuery("#message_"+msgid).css("display","block");
	jQuery("#chk_attachment_"+msgid).css("display","inline");
}

function showSubjectText(msgParentId){
	jQuery("#txt_subject_"+msgParentId).css("display","inline");
	jQuery("#btn_save_subject_"+msgParentId).css("display","inline-block");
	jQuery("#btn_edit_subject_"+msgParentId).css("display","none");
}
//-->
</script> 
			...
			<form action="<?php echo JRoute::_('index.php?option=com_jblance&view=admproject&layout=managemessage'); ?>" method="post" name="adminForm" id="adminForm">
				...
				<fieldset>
					...
					<table class="table table-striped">
						...
						?>
							<tr id="jbl_feed_item_<?php echo $row->id; ?>">
