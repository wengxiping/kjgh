...
Joomla.submitbutton = function(task){
	if (task == 'admproject.cancelsubscr' || document.formvalidator.isValid(document.getElementById('editsubscr-form'))) {
...
<div class="row-fluid">
	<div class="span4">
		<fieldset>
			...
			<div class="control-group">
	    		<label class="control-label" for="user_id"><?php echo JText::_('COM_JBLANCE_USERNAME'); ?>:</label>
				<div class="controls">
					<?php echo  $this->users; ?>
				</div>
	  		</div>
	...
	<div class="span4">
		<fieldset>
			...
			<div class="control-group">
	  		...
	  		<?php endif; ?>
			<div class="control-group">
	    		<label class="control-label" for="plan_id"><?php echo JText::_('COM_JBLANCE_PLAN_NAME'); ?>:</label>
				<div class="controls">
					<?php echo $this->plans; ?>
				</div>
	  		</div>
			<div class="control-group">
	    		<label class="control-label" for="approved"><?php echo JText::_('COM_JBLANCE_STATUS'); ?>:</label>
				<div class="controls">
