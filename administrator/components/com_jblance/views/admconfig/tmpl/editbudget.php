 ...
 */
 ...
 Joomla.submitbutton = function(task){
 	if(task != 'admconfig.cancelbudget'){
	 	var budgetmin = parseFloat(jQuery("#budgetmin").val());
		var budgetmax = parseFloat(jQuery("#budgetmax").val());

		if(budgetmin > budgetmax){
			alert('<?php echo JText::_('COM_JBLANCE_MIN_BUDGET_MORE_THAN_MAX_BUDGET', true); ?>');
			return false;
		}
	 }
	 if (task == 'admconfig.cancelbudget' || document.formvalidator.isValid(document.getElementById('editbudget-form'))) {
