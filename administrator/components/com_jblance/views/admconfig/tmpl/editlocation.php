...
Joomla.submitbutton = function(task){
	if (task == 'admconfig.cancellocation' || document.formvalidator.isValid(document.getElementById('editlocation-form'))) {
...
<form action="index.php" method="post" id="editlocation-form" name="adminForm" class="form-validate form-horizontal">
	...
	<div class="row-fluid">
		<div class="span6">
			...
			<div class="control-group">
	    		<label class="control-label" for="alias"><?php echo JText::_('JFIELD_ALIAS_LABEL'); ?>:</label>
				<div class="controls">
					<input class="input-medium" type="text" name="alias" id="alias" value="<?php echo $this->row->alias; ?>" />
				</div>
	  		</div>
			<div class="control-group">
				...
				<div class="controls">
					...
					$locationTree = $select->getSelectLocationTree('parent_id', $this->row->parent_id, $this->row->id, 'JGLOBAL_ROOT_PARENT', $attribs, '');
					echo $locationTree;
					?>
				</div>
	  		</div>
	...
	<div class="row-fluid">
		<div class="span6">
			<div class="control-group">
				...
				<div class="controls">
					<input class="input-small" type="text" name="params[latitude]" id="paramsLatitude" value="<?php echo $params->get('latitude', ''); ?>" />
				</div>
	  		</div>
			<div class="control-group">
	    		<label class="control-label" for="paramsLongitude"><?php echo JText::_('COM_JBLANCE_LONGITUDE'); ?>:</label>
				<div class="controls">
					<input class="input-small" type="text" name="params[longitude]" id="paramsLongitude" value="<?php echo $params->get('longitude', ''); ?>" />
				</div>
	  		</div>
	  	</div>
	</div>
