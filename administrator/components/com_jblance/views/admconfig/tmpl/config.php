...
Joomla.submitbutton = function(task){
	if (task == 'admconfig.cancelconfig' || document.formvalidator.isValid(document.getElementById('editconfig-form'))) {
	...
	<div class="row-fluid">
		...
		<div class="span6">
			<fieldset>
				...
				<div class="control-group">
					<?php $tip = JHtml::tooltipText(JText::_('COM_JBLANCE_PROJECTS_MATCH_SKILLS_EXAMPLE')); ?>
		    		<label class="control-label hasTooltip" for="paramsProjectMatchSkills" title="<?php echo $tip; ?>"><?php echo JText::_('COM_JBLANCE_PROJECTS_MATCH_SKILLS'); ?>:</label>
					<div class="controls">						
						<?php $projectMatchSkills = $select->YesNoBool('params[projectMatchSkills]', $this->params->projectMatchSkills);
						echo  $projectMatchSkills; ?>
					</div>
			  	</div>
				<div class="control-group">
					<?php $tip = JHtml::tooltipText(JText::_('COM_JBLANCE_PROJECTS_MATCH_LOCATION_EXAMPLE')); ?>
		    		<label class="control-label hasTooltip" for="paramsProjectMatchLocation" title="<?php echo $tip; ?>"><?php echo JText::_('COM_JBLANCE_PROJECTS_MATCH_LOCATION'); ?>:</label>
					<div class="controls">						
						<?php $projectMatchLocation = $select->YesNoBool('params[projectMatchLocation]', $this->params->projectMatchLocation);
						echo  $projectMatchLocation; ?>
					</div>
			  	</div>
			</fieldset>
			<fieldset>
				<legend><?php echo JText::_('COM_JBLANCE_PRIVACY'); ?></legend>
				<div class="control-group">
			  	...
			  	<div class="control-group">
					<?php $tip = JHtml::tooltipText(JText::_('COM_JBLANCE_SHOW_BUSINESS_NAME_EXAMPLE')); ?>
		    		<label class="control-label hasTooltip" for="paramsShowBizName" title="<?php echo $tip; ?>"><?php echo JText::_('COM_JBLANCE_SHOW_BUSINESS_NAME'); ?>:</label>
					<div class="controls">						
						<?php $showBizName = $select->YesNoBool('params[showBizName]', $this->params->showBizName);
						echo  $showBizName; ?>
					</div>
			  	</div>
			</fieldset>
			<fieldset>
				...
				<div class="control-group">
					...
					<div class="controls">						
						<textarea name="params[reportCategory]" id="reportCategory" class="input-xlarge required" rows="6"><?php echo $this->params->reportCategory; ?></textarea>
					</div>
			  	</div>
			</fieldset>
			<fieldset>
		...
		<div class="span6">
			<fieldset class="adminform">
				...
				<div class="control-group">
					...
					<div class="controls">
						<?php 
						$link_plugin = JRoute::_('index.php?option=com_plugins&view=plugins&filter_search=freelance redirector');
						?>
			...
			<fieldset class="adminform">
				<legend><?php echo JText::_('COM_JBLANCE_GOOGLE_MAPS'); ?></legend>
				<div class="control-group">
					<?php $tip = JHtml::tooltipText(JText::_('COM_JBLANCE_GOOGE_MAPS_API_KEY_EXAMPLE')); ?>
		    		<label class="control-label hasTooltip" for="paramsGmapApikey" title="<?php echo $tip; ?>"><?php echo JText::_('COM_JBLANCE_GOOGE_MAPS_API_KEY'); ?>:</label>
					<div class="controls">
						<input class="input-xlarge" type="text" name="params[gmapApikey]" id="paramsGmapApikey" maxlength="100" value="<?php echo $this->params->gmapApikey; ?>" />
					</div>
			  	</div>
			</fieldset>		
		</div>
