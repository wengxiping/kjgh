...
Joomla.submitbutton = function(task){
	if(document.formvalidator.isValid(document.getElementById('emailtemp-form'))) {
				...
				<ul class="nav" role="navigation">
					<li class="dropdown">
						...
						<ul class="dropdown-menu">
							...
							<li><a href="<?php echo $link.'subscr-expiry-reminder'; ?>"><?php echo JText::_('COM_JBLANCE_SUBSCRIPTION_EXPIRY_REMINDER'); ?></a></li>
						</ul>
					</li>
					<li class="dropdown">
