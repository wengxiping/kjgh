 ...
 */
 ...
 $options->loadString($this->row->option_params);
 	
 ?>
<script type="text/javascript">
<!--
Joomla.submitbutton = function(task){
	if (task == 'admconfig.cancelplan' || document.formvalidator.isValid(document.getElementById('editplan-form'))) {
	...
	<div class="row-fluid">
		<div class="span6">
		    ...
		    <fieldset class="form-vertical">
				...
				<div class="control-group">
					...
					<div class="controls">
						<textarea name="description" id="description" class="input-xxlarge" rows="5"><?php echo $this->row->description; ?></textarea>
					</div>
		  		</div>
		  		<div class="control-group">
		    		<label class="control-label" for="finish_msg"><?php echo JText::_('COM_JBLANCE_FINAL_MESSAGE'); ?>:</label>
					<div class="controls">
						<textarea name="finish_msg" id="finish_msg" class="input-xxlarge" rows="3"><?php echo $this->row->finish_msg; ?></textarea>
					</div>
		  		</div>
			</fieldset>		
		</div>
		<div class="span6">
			...
			<fieldset>
				...
				<div class="control-group">
		    		<label class="control-label" for="option_paramstheme"><?php echo JText::_('COM_JBLANCE_THEME'); ?>:</label>
					<div class="controls">
						<?php
						$val = $options->get('theme', 'blue');
						$attribs = 'class="input-medium required" size="1"';
		          		echo $model->getSelectTheme('option_params[theme]', $val, 'COM_JBLANCE_SELECT_USERGROUP', $attribs, ''); ?>
					</div>
		  		</div>
			</fieldset>		
		</div>
