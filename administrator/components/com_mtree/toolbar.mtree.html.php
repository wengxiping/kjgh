...
class TOOLBAR_mtree {
	...
	*/
	public static function CONFIG_MENU() {
		...
		$bar = JToolBar::getInstance('toolbar');
		$bar->appendButton('Link', 'cancel', 'JTOOLBAR_CANCEL', 'index.php?option=com_mtree' );
	...
	* My Subscription
	*/
	public static function MY_SUBSCRIPTION_MENU() {
		JToolBarHelper::title( JText::_( 'COM_MTREE_MY_SUBSCRIPTION_TITLE' ) );
