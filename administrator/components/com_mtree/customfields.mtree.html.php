...
class HTML_mtcustomfields {
	...
	Joomla.submitbutton = function(task) {
		...
		} else if (form.iscore.value == "0" && ( form.field_type.value == "checkbox" || form.field_type.value == "selectlist" || form.field_type.value == "mselectmultiple" || form.field_type.value == "radiobutton" ) && form.field_elements.value == "" ) {
	...
	function updateInputs(ftype) {
		...
		// No search
		if(ftype=='associatedlisting'||ftype=='coreuser'||ftype=='listings') {
		...
		if (ftype=='selectlist'||ftype=='mselectmultiple'||ftype=='checkbox'||ftype=='radiobutton'||ftype=='corecountry'||ftype=='corestate'||ftype=='corecity'||ftype=='coreyear'||ftype=='corepostcode'<?php
		...
		if (ftype=='selectlist'||ftype=='mselectmultiple'||ftype=='checkbox'||ftype=='radiobutton'||ftype=='corecountry'||ftype=='corestate'||ftype=='corecity'||ftype=='corepostcode'<?php
		foreach( $custom_cf_types AS $custom_cf_type ) {
		...
		if (ftype=='coreprice'||ftype=='corefirstname'||ftype=='corelastname'||ftype=='coreaddress'||ftype=='corepostcode'||ftype=='corecontactperson'||ftype=='coremobile'||ftype=='coredate'||ftype=='coreyear'||ftype=='coretelephone'||ftype=='corefax'||ftype=='coreemail'||ftype=='corewebsite'||ftype=='corename'||ftype=='coredesc'||ftype=='coremetakey'||ftype==''||ftype=='coremetadesc'||ftype=='corecountry'||ftype=='corestate'||ftype=='corecity'<?php
		foreach( $custom_cf_types AS $custom_cf_type ) {
	...
	<div class="row-fluid">
		<div class="span<?php echo (intval($row->cf_id)>0 && !empty($fieldsets))?'7':'12'; ?>">
			...
			<div class="control-group">
				<div class="control-label">
					<label title="<?php echo JText::_( 'COM_MTREE_VIEW_ACCESS_LEVEL' ) ?>::<?php echo JText::_( 'COM_MTREE_VIEW_ACCESS_LEVEL_TOOLTIP' ) ?>" class="hasTip"><?php echo JText::_( 'COM_MTREE_VIEW_ACCESS_LEVEL' ) ?>:</label>
				</div>
				<div class="controls">
					<?php echo $lists['view_access_level'] ?>
				</div>
			</div>
			<div class="control-group">
				<div class="control-label">
					<label title="<?php echo JText::_( 'COM_MTREE_EDIT_ACCESS_LEVEL' ) ?>::<?php echo JText::_( 'COM_MTREE_EDIT_ACCESS_LEVEL_TOOLTIP' ) ?>" class="hasTip"><?php echo JText::_( 'COM_MTREE_EDIT_ACCESS_LEVEL' ) ?>:</label>
				</div>
				<div class="controls">
					<?php echo $lists['edit_access_level'] ?>
				</div>
			</div>
			<div class="control-group">
				<div class="control-label">
			...
			if ($row->iscore == 1) { ?>
				<div class="control-group">
					<div class="control-label">
						<label title="<?php echo JText::_( 'COM_MTREE_SHOWN_IN_BACKEND_LISTINGS_COLUMN' ) ?>::<?php echo JText::_( 'COM_MTREE_SHOWN_IN_BACKEND_LISTINGS_COLUMN_TOOLTIP' ) ?>" class="hasTip"><?php echo JText::_( 'COM_MTREE_SHOWN_IN_BACKEND_LISTINGS_COLUMN' ) ?>:</label>
					</div>
					<div class="controls">
						<?php bootstrapRadioBoolean('shown_in_backend_listings_column', $row->shown_in_backend_listings_column, in_array('hidden', $isDisabled), JText::_( 'JSHOW' ), JText::_( 'JHIDE' )); ?>
					</div>
				</div>
			<?php
			}
