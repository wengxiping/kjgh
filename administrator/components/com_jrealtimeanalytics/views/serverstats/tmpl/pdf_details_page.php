...
<table>
	<tr>
		<td style="background-color: #d9edf7;" width="18%">
		...
		<?php if($this->cparams->get('xtd_singleuser_stats', 0)) :?>
			<?php if(!$this->cparams->get('anonymize_ipaddress', 0)):?>
				<td width="10%">
					<b style="font-size:14px;color: #3a87ad;"><?php echo JText::_('COM_JREALTIME_SERVERSTATS_IPADDRESS');?></b>
				</td>
			<?php endif;?>
			<td width="10%">
			...
			<td width="10%">
				<b style="font-size:14px;color: #3a87ad;"><?php echo JText::_('COM_JREALTIME_SERVERSTATS_BROWSERNAME');?></b>
			</td>
			<td width="10%">
				<b style="font-size:14px;color: #3a87ad;"><?php echo JText::_('COM_JREALTIME_SERVERSTATS_OS_TITLE');?></b>
			</td>
			<td width="10%">
				<b style="font-size:14px;color: #3a87ad;"><?php echo JText::_('COM_JREALTIME_SERVERSTATS_DEVICE');?></b>
			</td>
		<?php endif;?>
	</tr>
	<?php 
