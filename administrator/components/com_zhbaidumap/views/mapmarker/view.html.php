...
/**
 * ZhBaidu MapMarker View
 */
class ZhBaiduMapViewMapMarker extends JViewLegacy
{
	/**
	 * display method of ZhBaidu MapMarker view
	 * @return void
	 */
	...
	protected function addToolBar() 
	{
		...
		$canDo = ZhBaiduMapHelper::getMarkerActions($this->item->id);
		JToolBarHelper::title($isNew ? JText::_('COM_ZHBAIDUMAP_MAPMARKER_NEW') : JText::_('COM_ZHBAIDUMAP_MAPMARKER_EDIT'), 'mapmarker');
	...
	protected function setDocument() 
	{
		...
		$document->setTitle($isNew ? JText::_('COM_ZHBAIDUMAP_ADMINISTRATION_MAPMARKER_CREATING') : JText::_('COM_ZHBAIDUMAP_ADMINISTRATION_MAPMARKER_EDITING'));
		$document->addScript(JURI::root() . $this->script);
		$document->addScript(JURI::root() . "administrator/components/com_zhbaidumap/views/mapmarker/submitbutton.js");
		JText::script('COM_ZHBAIDUMAP_MAPMARKER_ERROR_UNACCEPTABLE');
	}
}
