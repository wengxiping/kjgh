...
/**
 * ZhBaidu MapRouter View
 */
class ZhBaiduMapViewMapRouter extends JViewLegacy
{
	/**
	 * display method of ZhBaidu MapRouter view
	 * @return void
	 */
	...
	protected function addToolBar() 
	{
		...
		JToolBarHelper::title($isNew ? JText::_('COM_ZHBAIDUMAP_MAPROUTER_NEW') : JText::_('COM_ZHBAIDUMAP_MAPROUTER_EDIT'), 'maprouter');
	...
	protected function setDocument() 
	{
		...
		$document->setTitle($isNew ? JText::_('COM_ZHBAIDUMAP_ADMINISTRATION_MAPROUTER_CREATING') : JText::_('COM_ZHBAIDUMAP_ADMINISTRATION_MAPROUTER_EDITING'));
		$document->addScript(JURI::root() . $this->script);
		$document->addScript(JURI::root() . "administrator/components/com_zhbaidumap/views/maprouter/submitbutton.js");
		JText::script('COM_ZHBAIDUMAP_MAPROUTER_ERROR_UNACCEPTABLE');
	}
}
