...
/**
 * View class for the ZhBaidu MapPaths Component
 */
class ZhBaiduMapViewMapPaths extends JViewLegacy
{
	...
	function display($tpl = null) 
	{
		...
		ZhBaiduMapHelper::addSubmenu('mappaths');
	...
	{
		$canDo = ZhBaiduMapHelper::getPathActions();
		JToolBarHelper::title(JText::_('COM_ZHBAIDUMAP_MAPPATH_MANAGER'), 'mappath');
		...
		JHtmlSidebar::addFilter(
			JText::_('COM_ZHBAIDUMAP_MAPPATH_FILTER_MAP'),
			'filter_mapid',
	...
	protected function setDocument() 
	{
		...
		$document->setTitle(JText::_('COM_ZHBAIDUMAP_MAPPATH_ADMINISTRATION'));
	}
	...
	protected function getSortFields()
	{
		return array(
			...
			'h.id' => JText::_('COM_ZHBAIDUMAP_MAPPATH_HEADING_ID'),
			'h.title' => JText::_('COM_ZHBAIDUMAP_MAPPATH_HEADING_TITLE'),
			'h.published' => JText::_('COM_ZHBAIDUMAP_MAPPATH_HEADING_PUBLISHED')
		);
	}
