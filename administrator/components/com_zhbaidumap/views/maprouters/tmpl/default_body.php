...
<?php 
	...
	$canDo = ZhBaiduMapHelper::getRouterActions($item->id);
	...
	<tr class="row<?php echo $i % 2; ?>">
		...
		<td>
			<?php if ($canEdit || $canEditOwn) : ?>
					<a href="<?php echo JRoute::_('index.php?option=com_zhbaidumap&task=maprouter.edit&id=' . $item->id); ?>">
		...
		<td align="center">
			<?php 
				echo JHtml::_('jgrid.published', $item->published, $i, 'maprouters.', $canChange, 'cb', $item->publish_up, $item->publish_down); 
