 ...
 * ZhBaiduMap Model
 */
class ZhBaiduMapModelMapMap extends JModelAdmin
{
	...
	{
		// Get the form.
		$form = $this->loadForm('com_zhbaidumap.mapmap', 'mapmap', array('control' => 'jform', 'load_data' => $loadData));
		if (empty($form)) 
		{
			return false;
		}
	...
	{
		return 'administrator/components/com_zhbaidumap/models/forms/mapmap.js';
	}
	/**
	...
	protected function loadFormData() 
	{
		...
		$data = JFactory::getApplication()->getUserState('com_zhbaidumap.edit.mapmap.data', array());
		if (empty($data)) 
		{
			$data = $this->getItem();
		}
