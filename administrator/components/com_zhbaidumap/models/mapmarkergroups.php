...
/**
 * ZhBaiduMarkerGroups Model
 */
class ZhBaiduMapModelMapMarkerGroups extends JModelList
{
	...
	protected function getListQuery() 
	{
		...
		$query->select('h.id,h.title,h.published,h.publish_up,h.publish_down,h.ordering,h.catid,h.icontype,c.title as category,h.userorder');
