...
$document->addScript(JUri::root(true).'/media/com_eventbooking/assets/js/eventbookingjq.js');
				...
				onValidationComplete: function(form, status){
					if (status == true) {
						$.ajax({
							...
							dataType: 'json',
							url: "<?php echo JUri::base(); ?>" + 'index.php?option=com_eventbooking&task=location.save_ajax',
							beforeSend: function () {
