...
<form action="<?php echo JRoute::_('index.php?option=com_menus&view=item&client_id=' . $clientId . '&layout=' . $layout . $tmpl . '&id=' . (int)$this->item->id); ?>"
      method="post" name="adminForm" id="item-form" class="form-validate new_validate">
    ...
    <?php if ($clientId === 1 && $this->item->id != 0) : ?>
        <div class="form-inline form-inline-header">
            <div class="control-group">
                ...
                <div class="controls">
                    <input class="input-xlarge" value="<?php echo JText::_($this->item->title); ?>" readonly="readonly"
                           type="text">
                </div>
            </div>
        </div>
        ...
        <div class="row-fluid">
            <div class="span9">
                ...
                echo $this->form->renderFieldset('request');
                 //dump($this->form->category);
                 //if($this->form->category){
                 //	die;
                 //}
                echo $this->form->category ? $this->form->renderField('category') : "";
                echo $this->form->categorylist ? $this->form->renderField('categorylist') : "";
                echo $this->form->categoryservicelist ? $this->form->renderField('categoryservicelist') : "";
               // dump($this->form);
               // echo $this->form->renderField('categorylist');
