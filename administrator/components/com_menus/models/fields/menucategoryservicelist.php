 ...
 * @since  1.7.0
 */
class JFormFieldMenuCategoryServiceList extends JFormField
{
    /**
     * The form field type.
     *
     ...
     * @since  1.7.0
     */
    protected $type = 'MenuCategoryServiceList';
...
//            ->select('*')
//            ->from('#__limit_category as a')->where("a.menu_id = 1");
//
...
//        $items = $db->setQuery($query)->loadObjectList();
        ...
        $items = $db->setQuery($query)->loadObjectList();
        $category = explode(",", $this->form->getData()->get('categoryservicelist'));
