...
class QrCodeWidgetsPages extends SocialAppsWidgets
{
	/**
	 * Renders QRCode on page (mobile)
	 *
	 * @since	3.0.0
	 * @access	public
	 */
	...
	{
		$permalink = ESR::pages(array('id' => $cluster->getAlias(),'appId' => $this->app->getAlias(),'layout' => 'item'));
	...
	/**
	 * Renders QRCode on page (desktop)
	 *
	 * @since	3.0.0
	 * @access	public
	 */
