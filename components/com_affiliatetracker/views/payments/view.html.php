...
class AffiliateViewPayments extends JViewLegacy
{
	...
	function display($tpl = null)
	{
		...
		$filter_order     = $mainframe->getUserStateFromRequest( 'affiliate.payments.filter_order', 'filter_order', 'pa.payment_datetime', 'cmd' );
        $filter_order_Dir = $mainframe->getUserStateFromRequest( 'affiliate.payments.filter_order_Dir', 'filter_order_Dir', 'desc', 'word' );
