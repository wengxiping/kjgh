...
<form action="<?php echo JRoute::_("index.php?option=com_affiliatetracker&view=payments".$itemid); ?>" method="get" name="adminForm" id="adminForm" class="navbar-form pull-left form-horizontal">
