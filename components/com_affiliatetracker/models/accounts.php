...
class AffiliateModelAccounts extends JModelLegacy
{
	...
	function _buildContentOrderBy(){
		...
		$filter_order     = $mainframe->getUserStateFromRequest( 'affiliate.conversions.order', 'filter_order', 'acc.id', 'cmd' );
		$filter_order_Dir = $mainframe->getUserStateFromRequest( 'affiliate.conversions.order_Dir', 'filter_order_Dir', 'desc', 'word' );
