...
class AffiliateModelPayments extends JModelLegacy
{
	...
	function __construct()
	{
		...
		$date_in = $mainframe->getUserStateFromRequest('affiliate.date_in','date_in','','cmd');
		$date_out = $mainframe->getUserStateFromRequest('affiliate.date_out','date_out','','cmd');
	...
	function _buildContentOrderBy(){
		...
		$filter_order     = $mainframe->getUserStateFromRequest( 'affiliate.payments.order', 'filter_order', 'pa.payment_datetime', 'cmd' );
		$filter_order_Dir = $mainframe->getUserStateFromRequest( 'affiliate.payments.order_Dir', 'filter_order_Dir', 'desc', 'word' );
