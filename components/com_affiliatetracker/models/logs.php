...
class AffiliateModelLogs extends JModelLegacy
{
	...
	function _buildContentOrderBy(){
		...
		$filter_order     = $mainframe->getUserStateFromRequest( 'affiliate.logs.order', 'filter_order', 'log.datetime', 'cmd' );
		$filter_order_Dir = $mainframe->getUserStateFromRequest( 'affiliate.logs.order_Dir', 'filter_order_Dir', 'desc', 'word' );
