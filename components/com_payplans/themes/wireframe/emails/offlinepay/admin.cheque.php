			...
			<table role="presentation" aria-hidden="true" cellspacing="0" cellpadding="0" border="0" width="100%">
				<tr>
					<td style="padding: 24px 24px 0; text-align: left;">
						<h1 style="margin: 0; font-family: sans-serif; font-size: 22px; line-height: 27px; color: #666666; font-weight: normal;"><?php echo JText::_('COM_PP_OFFLINE_PAY_ADMIN_HEADING');?></h1>
					</td>
				</tr>
			</table>
		</td>
						...
						<tr>
							<td valign="top" width="100%">
								...
								<p style="color: #999999;line-height:1.5;text-align:left;margin: 0;padding: 0 0 24px;" class="stack-column">
									<?php echo JText::_('COM_PP_NAME');?>: <?php echo $buyer->getName();?>
									<br />
									<?php echo JText::_('COM_PP_EMAIL_ADDRESS');?>: <?php echo $buyer->getEmail();?>
									<br />
									<?php echo JText::_('COM_PP_USERNAME');?>: <?php echo $buyer->getUsername();?>
									<br />
									<?php echo JText::_('COM_PP_PAYMENT_MODE');?>: <?php echo $params->get('from');?>
									<br />
									<?php echo JText::_('COM_PP_CHEQUE_NUMBER');?>: <?php echo $params->get('id');?>
								</p>
							</td>
						</tr>
					</table>
