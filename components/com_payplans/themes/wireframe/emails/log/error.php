			...
			<table role="presentation" aria-hidden="true" cellspacing="0" cellpadding="0" border="0" width="100%">
				<tr>
					<td style="padding: 24px 24px 0; text-align: left;">
						<h1 style="margin: 0; font-family: sans-serif; font-size: 22px; line-height: 27px; color: #666666; font-weight: normal;"><?php echo JText::_('COM_PP_ERROR_LOG_EMAIL_HEADING');?></h1>
					</td>
				</tr>
			</table>
		</td>
					...
					<table role="presentation" aria-hidden="true" border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width:660px;">
						<tr>
							<td valign="top" width="100%">
								...
								<div>
									<?php echo JText::_('COM_PAYPLANS_ERROR_LOG_DETAILS');?>
								</div>
								<ul>
									<li>
										<?php echo JText::_('COM_PAYPLANS_ERROR_LOG_MESSAGE');?>
										<?php echo $message;?>
									</li>
									<li>
										<?php echo JText::_('COM_PAYPLANS_ERROR_LOG_OBJECT_ID');?>
										<?php echo $object_id;?>
									</li>
									<li>
										<?php echo JText::_('COM_PAYPLANS_ERROR_LOG_CLASS');?>
										<?php echo $class;?>
									</li>
