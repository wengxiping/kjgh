...
<!-- show search fields if enabled -->
	...
	<div class="row-fluid top10">
		<div class="span12">
			<div id="filter-bar" class="">
				...
				<div class="btn-group">
					<button type="submit" class="btn hasTooltip" title="<?php echo JHtml::tooltipText('COM_JBLANCE_SEARCH'); ?>"><i class="jbf-icon-search"></i></button>
					<a href="<?php echo $action; ?>" class="btn hasTooltip" title="<?php echo JHtml::tooltipText('JSEARCH_FILTER_CLEAR'); ?>"><i class="jbf-icon-remove"></i></a>
				</div>
	...
	<div class="row-fluid pull-right">
		<div class="span12">
			<button type="submit" class="btn pull-right" title=""><i class="jbf-icon-search"></i> <?php echo JHtml::tooltipText('COM_JBLANCE_SEARCH'); ?></button>
		</div>
	</div>
	<?php endif; ?>
	...
	<div class="media">
		...
		<div class="media-body">
			<h5 class="media-heading">
				...
				<?php if(!$user->guest && !$isMine && $hasJBProfileForViewer && $viewerInfo->allowPostProjects){ ?>
				<span  class="pull-right">
				<span id="fav-msg-<?php echo $row->user_id; ?>">
					<?php if($isFavourite > 0) : ?>
					<a onclick="favourite('<?php echo $row->user_id; ?>', -1,'profile');" href="javascript:void(0);" class="btn btn-mini btn-danger"><span class="jbf-icon-minus-circle icon-white"></span> <?php echo JText::_('COM_JBLANCE_REMOVE_FAVOURITE')?></a>
					<?php else : ?>
				...
				<a class="btn btn-mini" href="<?php echo $link_sendpm; ?>"><i class="jbf-icon-comment"></i> <?php echo JText::_('COM_JBLANCE_SEND_MESSAGE'); ?></a>
				<?php } ?>
				</span>
			</h5>
			<div>
