...
<div class="jbl_h3title"><?php echo JText::_('COM_JBLANCE_PROFILE').' - '.$this->userInfo->name; ?></div>
	...
	<?php else : ?>
		...
		<div id="report-this" class="page-action">
		    <a href="<?php echo $link_report; ?>"><i class="jbf-icon-warning"></i> <?php echo JText::_('COM_JBLANCE_REPORT_USER'); ?></a>
		</div>
		<?php endif; ?>
		<div id="send-message" class="page-action">
		    <a href="<?php echo $link_sendpm; ?>"><i class="jbf-icon-comment"></i> <?php echo JText::_('COM_JBLANCE_SEND_MESSAGE'); ?></a>
		</div>
	<?php endif; ?>
	</div>
			...
			<div class="span5">
				...
				<div class="row-fluid">
					<div class="span12">
						...
						<a href="<?php echo $link_invite; ?>" class="btn btn-success btn-block btn-large jb-modal" rel="{handler: 'iframe', size: {x: 650, y: 400}}"><i class="jbf-icon-envelope"></i> <?php echo JText::_('COM_JBLANCE_INVITE_TO_PROJECT'); ?></a>
					</div>
				</div>
				<div class="sp10">&nbsp;</div>
				<div class="row-fluid">
					<div class="span6">
						...
						<span id="fav-msg-<?php echo $userid; ?>">
							...
							<a onclick="favourite('<?php echo $userid; ?>', -1,'profile');" href="javascript:void(0);" class="btn btn-danger btn-block"><span class="jbf-icon-minus-circle"></span> <?php echo JText::_('COM_JBLANCE_REMOVE_FAVOURITE')?></a>
							<?php else : ?>
							<a onclick="favourite('<?php echo $userid; ?>', 1,'profile');" href="javascript:void(0);" class="btn btn-block"><span class="jbf-icon-plus-circle"></span> <?php echo JText::_('COM_JBLANCE_ADD_FAVOURITE')?></a>
							<?php endif; ?>
						</span>
					</div>
					<div class="span6">
						<a class="btn btn-block" href="<?php echo $link_sendpm; ?>"><i class="jbf-icon-comment"></i> <?php echo JText::_('COM_JBLANCE_SEND_MESSAGE'); ?></a>
					</div>
				</div>
				<?php endif; ?>
			</div>
	...
	<div class="row-fluid">
		...
		for($i=0, $n=count($this->portfolios); $i < $n; $i++){
			...
			if(($portfolio->picture !== '') && ($portfolio->picture !== '{}')) {
			...
			<li class="span4 thumbfix">
				<div class="thumbnail">
					...
					<div class="caption">
						<h3 class="jbf-truncate"><?php echo $portfolio->title; ?></h3>
	...
	<?php 
		...
		echo "<div class='alert alert-info'>".JText::_('COM_JBLANCE_NO_PORTFOLIO_FOUND')."</div>";
	...
	<?php 
			...
			echo "<div class='alert alert-info'>".JText::_('COM_JBLANCE_NO_PROJECTS_FOUND')."</div>";
		endif;	
	?>
	...
	<?php 
		...
		echo "<div class='alert alert-info'>".JText::_('COM_JBLANCE_RATING_NOT_FOUND')."</div>";
	endif; ?>
