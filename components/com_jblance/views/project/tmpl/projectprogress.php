...
<div class="bidTitle"> <a href="javascript:history.go(-1);">我的出价</a> > <span>编辑出价</span></div>
	<!-- <div class="jbl_h3title"><?php echo JText::_('COM_JBLANCE_PROJECT_PROGRESS'); ?></div> -->
	<div class="projectDetailsBox">
	<div class="row-fluid projectDetails">
		<div class="span6">
				...
				<ol class="carousel-indicators">
  				...
  				<div class="carousel-inner" role="listbox">
    				...
    				<div class="item active">
     				 	<img src="components/com_jblance/images/default" alt="">
    				</div>
  				</div>
	...
	<div class="row-fluid">
 		<div class="span12">
 			<fieldset class="form-vertical">
 				...
 				<div class="row-fluid progressbox">
 					<div class="span8">
					    <div class="progressLabel">需求进度 :</div >
		 				<?php if($isfreelancer) : ?>
		 				...
		 				<div class="control-group" id="div_p_percent">
							...
							<div class="controls">
								<input type="text" name="p_percent" id="p_percent" class="input-xlarge" value="<?php echo $project->p_percent; ?>" data-slider-value="<?php echo $project->p_percent; ?>" style="display: none;" />
		 						<span> <span id="p_percent_text"><?php echo $project->p_percent; ?></span>%</span>
							</div>
						</div>
		 				<div class="control-group">
                    ...
                    <?php if($isfreelancer && $project->p_status != 'COM_JBLANCE_COMPLETED') : ?>
                        <div class="updateProgress">
                            <button type="submit" id="submitbtn" ><?php echo JText::_('COM_JBLANCE_UPDATE_PROGRESS'); ?></button>
                        </div>
                    <?php endif; ?>
                    <div class="span4">
                        <?php if($project->p_started != "0000-00-00 00:00:00") : ?>
                            <div class="control-group">
                                <span><?php echo JText::_('COM_JBLANCE_STARTED'); ?> :</span>
                        ...
                        <?php if($project->p_updated != "0000-00-00 00:00:00") : ?>
                            <div class="control-group">
                                <span><?php echo JText::_('COM_JBLANCE_LAST_UPDATED'); ?> :</span>
                        ...
                        <?php if($project->p_ended != "0000-00-00 00:00:00") : ?>
                            <div class="control-group">
                                <span><?php echo JText::_('COM_JBLANCE_COMPLETED'); ?> :</span>
...
<form action="<?php echo JRoute::_('index.php'); ?>" method="post" name="progress-message" id="progress-message" class="form-validate" onsubmit="return validateFormMessage(this);">
	...
	<ul class="jb-chat">
		...
		for($i=0, $x=count($this->messages); $i < $x; $i++){
			...
			<!-- 设计图没有先隐藏 -->
			<li class="left clearfix" style="display:none;">
				...
				<!-- <div class="jb-chat-body clearfix">
					<div class="header">
						...
						<small class="pull-right text-muted">
							<span class="jbf-icon-clock"></span> <?php echo JHtml::_('date', $message->date_sent, $dformat, true); ?>
						</small>
					</div>
					<p>
					<?php
	...
	<div class="projectDetailsBox">
	<div class="control-group">
		<div class="progressLabel">在线咨询 :</div >
...
<!--				     <span class="hasTooltip" title="--><?php //echo $tipmsg; ?><!--"><i class="jbf-icon-question-sign"></i></span>-->
				   <button type="button" id="uploadmessage" class="project-button-upload"><?php echo JText::_('COM_JBLANCE_ATTACH_FILE'); ?></button>
			    </div>
			    <div class="sp10">&nbsp;</div>
			    ...
			    <div style="margin-top:20px">
				    <button type="submit" class="btn btn-primary" id="btnsend"><?php echo JText::_('COM_JBLANCE_SEND'); ?></button>
			    </div>
			</div>
		</div>
	</div>
