        ...
        $("#commentForm").on("submit", function (e) {
            ...
            var myRequest = $.ajax({
                ...
                beforeSend: function () {
                    $("#btnSendMessage").prop({
                        "disabled": true,
                        "value": "<?php echo JText::_('COM_JBLANCE_SENDING'); ?>"
                    });
                },
...
<div class="project">
    <div class="pull-left">
        <div class="span12">
            <?php  $ret = JBMediaHelper::renderImageCarousel($row->project_image, 'project');
            if($ret){
                echo $ret;
            }else{
                echo "<img src='/images/jblance/profile/prof_1043_1576302002.jpg' style='width: 100%;'>";
            }
            ?>
        </div>
    </div>
    <div class="pull-right">
        <div class="pr-top">
          ...
          <div class="project_h3title_new">
            <div class="title-h3">
                <?php echo $row->project_title; ?>
                <!-- <small><?php echo JText::_('COM_JBLANCE_PROJECT_DETAILS'); ?></small> -->
            </div>
            <div>
                <div id="report-this" class="page-action">
                    <a href="<?php echo $link_report; ?>"><img src="components/com_jblance/images/project/report.png"
                                                               alt=""> <?php echo JText::_('COM_JBLANCE_REPORT_PROJECT'); ?>
                    </a>
                </div>
                <div id="send-message" class="page-action">
                    ...
                    <a href="<?php echo $link_sendpm; ?>"><img src="components/com_jblance/images/project/advisory.png"
                                                               alt=""> <?php echo JText::_('COM_JBLANCE_SEND_MESSAGE'); ?>
                    </a>
                </div>
            </div>

        </div>
           <div class="project_status" style="position: relative;">
            <div class="project-label">
                <span class="boldfont greenfont font16"><?php echo strtoupper(JText::_($row->status)); ?></span>
            </div>
        ...
        <div class="pr-bottom">
           ...
           <div class="project_content">
                <div class="">
                    <div style="display:inline-block; padding: 0 5px 0 5px;" class="jb-aligncenter border-r">
                    ...
                    <div style="display:inline-block; padding: 0 5px 0 5px;" class="jb-aligncenter border-r">
                        ...
                        <div class="boldfont skybluefont font20">
                            ...
                            <?php if ($sealProjectBids || $row->is_sealed) : ?>
                                <span class="label label-info"><?php echo JText::_('COM_JBLANCE_SEALED'); ?></span>
                            <?php else : ?>
                                <?php echo JblanceHelper::formatCurrency($avg, true, 0, 0); ?><span
                                        class="font14"><?php echo ($row->project_type == 'COM_JBLANCE_HOURLY') ? ' / ' . JText::_('COM_JBLANCE_HR') : ''; ?></span>
                            <?php endif; ?>
                        </div>
                    </div>
                    <div style="display:inline-block; padding: 0 5px 0 5px;" class="jb-aligncenter">
                        <div class="margin-b5"><?php echo JText::_('COM_JBLANCE_BUDGET') . ' (' . $currencycode . ')'; ?></div>
                        <div class="boldfont skybluefont font20">
                            <?php echo JblanceHelper::formatCurrency($row->budgetmin, true, false, 0); ?>
                            - <?php echo JblanceHelper::formatCurrency($row->budgetmax, true, false, 0); ?><span
                                    class="font14"><?php echo ($row->project_type == 'COM_JBLANCE_HOURLY') ? ' / ' . JText::_('COM_JBLANCE_HR') : ''; ?></span>
                        </div>
                    </div>
                </div>
           ...
           <div class="project-applyBox">
            ...
            <?php if ($row->status == 'COM_JBLANCE_OPEN' && !$isMine) : ?>
                ...
                <div class="tb-action">
                  <a href="<?php echo $link_place_bid; ?>"
                   class=""><?php echo JText::_('COM_JBLANCE_BID_ON_THIS_PROJECT'); ?></a>
                </div>
            <?php endif; ?>
            <div class="page-actions  xp-action">
                <?php if ($enableAddThis) : ?>
                    <div class="xp-share-btn" id="xp-share-btn">
                        <div class="share-img"><img src="components/com_jblance/images/project/shave.png"/></div>
                        <div class="txt">去分享</div>
                    </div>
                    <div id="social-bookmark" class="page-action">
                        ...
                        <script type="text/javascript"
                                src="http://s7.addthis.com/js/250/addthis_widget.js#pubid=<?php echo $addThisPubid; ?>"></script>
                        <!-- AddThis Button END -->
                    </div>
                ...
                <?php if ($isMine) :
                    if ($row->status == 'COM_JBLANCE_OPEN' || $row->status == 'COM_JBLANCE_EXPIRED') { ?>
                        <div id="edit-project" class="page-action">
                            <a href="<?php echo $link_edit_project; ?>"><i
                                        class="jbf-icon-edit"></i> <?php echo JText::_('COM_JBLANCE_EDIT_PROJECT'); ?>
                            </a>
                        </div>
                    <?php } ?>
                    ...
                    <div id="pick-user" class="page-action">
                        <a href="<?php echo $link_pick_user; ?>"><i
                                    class="jbf-icon-location"></i> <?php echo JText::_('COM_JBLANCE_PICK_USER') . ' (' . count($this->bids) . ')'; ?>
                        </a>
                    </div>
                <?php endif; ?>
                <?php else : ?>
...
<div class="row-fluid project-des">
    <div class="span8" style="padding: 20px !important;">

        <h4><?php echo JText::_('COM_JBLANCE_PROJECT_DESCRIPTION'); ?>:</h4>
        <div style="text-align: justify;margin-bottom:26px;"><?php echo nl2br($row->description); ?></div>
        ...
        <div class="location"><?php echo JblanceHelper::getLocationNames($row->id_location, 'only-location'); ?></div>
        <?php
                        ...
                        foreach ($children as $ct) {
                            if ($ct->parent == $pt->id) { ?>
                                <div class="control-group">
                                    <label class="control-label nopadding"><?php echo JText::_($ct->field_title); ?>
                                        : </label>
                                    <div class="controls">
    ...
    <div class="span4">
        <div class="media">
            ...
            <div>
                <span>地址 : <span><?php echo JblanceHelper::getLocationNames($row->id_location, 'only-location'); ?></span> </span>
            </div>
<!--            <div class=""><a href="#addmessage_bm" class="btn">--><?php //echo JText::_('COM_JBLANCE_ADD_MESSAGE'); ?><!--</a>-->
<!--            </div>-->
            <div style="margin-top: 5px;">
                <?php JblanceHelper::getAvarageRate($row->publisher_userid); ?>
            </div>
        </div>
        <div class="row-fluid publicClarificationBoard">
            <div class="span12">
                ...
                <div id="comments">
                    ...
                    <form id="commentForm" method="post" action="<?php echo JRoute::_('index.php'); ?>"
                          class="form-inline">
                        ...
                        if (($user->id == $row->publisher_userid) || $hasBid) :
                            ...
                            <div class="well">
                                ...
                                <input type="submit" value="<?php echo JText::_('COM_JBLANCE_POST_MESSAGE'); ?>"
                                       id="btnSendMessage" class="btn btn-primary"/>
                                <div style="margin-top: 5px;text-align: left;"><?php echo JText::_('COM_JBLANCE_SHARING_CONTACT_PROHIBITED'); ?></div>
                                <input type="hidden" name="project_id" value="<?php echo $row->id; ?>"/>
                                <input type="hidden" name="user_id" value="<?php echo $user->id; ?>"/>
                            </div>
                        <?php
                        else : ?>
                            <div class="alert alert-info"><?php echo JText::_('COM_JBLANCE_MUST_BID_TO_POST_MESSAGES'); ?></div>
                        <?php
                        endif;
                        ?>
                    </form>
        ...
        <div class="row-fluid publicClarificationBoard">
            <div class="span12">
                ...
                <?php if (($sealProjectBids || $row->is_sealed) && ($user->id != $row->publisher_userid) && !$hasBid) : ?>
                    <div class="alert alert-info"><?php echo JText::_('COM_JBLANCE_SEALED_PROJECT_PULBISHER_AND_BIDDERS_SEE_DETAILS'); ?></div>
                <?php else : ?>
                    <?php
                    if (!count($this->bids))
                        echo "<div class=\"alert alert-info\">" . JText::_('COM_JBLANCE_THERE_ARE_NO_BIDS_YET') . "</div>";
                    else {
                        for ($i = 0, $n = count($this->bids); $i < $n; $i++) {
                            $bid = $this->bids[$i];
                            ?>
                            <div class="row-fluid"
                                 style="padding-top:10px;display:flex;justify-content: space-between;">
                                <div class="span1" style="width:40px;padding:0 !important;">
                                    <?php
                                    $attrib = 'width=40 height=40 class="img-polaroid"';
                                ...
                                <div class="span2" style="width:110px;">
                                    ...
                                    <div class="text-center" style="text-align: left;margin-top:6px;">
                                        <span class="font20"><?php echo JblanceHelper::formatCurrency($bid->amount, true, false, 0); ?></span><?php echo ($row->project_type == 'COM_JBLANCE_HOURLY') ? ' / ' . JText::_('COM_JBLANCE_HR') : ''; ?>
                                        /
                                        <span class="font12">
