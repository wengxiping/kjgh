...
<div class="project">
    <div class="pull-left">
        <div class="span12">
            <?php echo JBMediaHelper::renderImageCarousel($row->project_image, 'project'); ?>
        </div>
    </div>
    <div class="pull-right">
        <div class="jbl_h3title project_h3title">
            <h3>
        ...
        <div class="project-applyBox">
            ...
            <div class="page-actions  xp-action">
                <?php if ($enableAddThis) : ?>
                    ...
                    <div class="xp-share-btn" style="display: none">
                        <div class="share-img"><img src="components/com_jblance/images/project/shave.png"/></div>
                        <div class="txt">去分享</div>
                    </div>
                    <div id="social-bookmark" class="page-action" style="display: none">
                        <!-- AddThis Button BEGIN -->
                        <div class="addthis_toolbox addthis_default_style ">
                            <a class="addthis_button_facebook_like" fb:like:layout="button_count"></a>
                            <a class="addthis_button_tweet"></a>
