...
<form action="<?php echo JRoute::_('index.php'); ?>" method="post" name="userFormProject" id="userFormProject" class="form-validate form-horizontal" onsubmit="return validateForm(this);">
	<div class="jbl_h3title"><?php echo ($target_rate_type == 'COM_JBLANCE_BUYER')?JText::_('COM_JBLANCE_RATE_USER'):"评价服务商"; ?></div>
	...
	<div class="control-group">
		<label class="control-label"><?php echo ($target_rate_type == 'COM_JBLANCE_BUYER')?JText::_('COM_JBLANCE_NAME'):"服务商昵称"; ?>: </label>
		<div class="controls">
			<?php
			$target_user = JFactory::getUser($target);
			echo $target_user->$nameOrUsername; ?>
		</div>
	</div>
	<div class="control-group">
	...
	<div class="control-group">
		<label class="control-label" for="communicate"><?php echo ($target_rate_type == 'COM_JBLANCE_BUYER')?JText::_('COM_JBLANCE_COMMUNICATION'):JText::_('COM_JBLANCE_EXPERTISE'); ?>: </label>
		<div class="controls brating">
	...
	<div class="control-group">
		<label class="control-label" for="expertise_payment"><?php echo ($target_rate_type == 'COM_JBLANCE_BUYER') ? JText::_('COM_JBLANCE_PAYMENT_PROMPTNESS') : '专业水平'; ?>: </label>
		<div class="controls brating">
	...
	<div class="control-group">
		<label class="control-label" for="professional"><?php echo ($target_rate_type == 'COM_JBLANCE_BUYER') ?JText::_('COM_JBLANCE_PROFESSIONALISM'):'工作效率'; ?>: </label>
		<div class="controls brating">
