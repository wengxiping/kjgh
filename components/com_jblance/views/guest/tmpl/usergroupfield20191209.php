...
<!--	<div class="jbl_h3title">--><?php //echo JText::_('COM_JBLANCE_PROFILE_INFO'); ?><!--</div>-->
    <div  class="head-top" id="head-top">完善信息</div>
	<fieldset  class="content-fieldset" id="content-fieldset">
        ...
        <div class="input-container-div">
            <label class="label-style">用户昵称</label>：
            <input type="text" class="input-info"/>
        </div>
        <div class="input-container-div">
            <label class="label-style">用户昵称</label>：
        ...
        <div class="input-container-div">
            <label class="label-style">公司名称</label>：
            <input type="text" class="input-info"/>
        </div>
        <div class="input-container-div">
            <label class="label-style">联系电话</label>：
            <input type="text" class="input-info"/>
        </div>
        <div class="input-container-div">
            <label class="label-style">联系地址</label>：
            <div class="select-group">
                <select class="select-info" placeholder="请选择">
                    <option value=''></option>
        ...
        <div class="input-container-div">
            <label class="label-style">门牌街道</label>：
            <textarea rows="5" cols="30" class="textarea-info"></textarea>
        </div>
        <div class="input-container-div">
            <label class="label-style">邮编</label>：
            <input type="text" class="input-info"/>
        </div>
        <div class="input-container-div">
            <label class="label-style">性别</label>：
            <div class="select-group">
                <select class="select-info" placeholder="请选择">
                    <option value=''></option>
                    <option value=''>广东</option>
                ...
                <div style="margin-left: 100px">
                    <label class="label-style">展示状态</label>：
                </div>
                <select class="select-info" placeholder="请选择">
                    <option value=''></option>
                    <option value=''>广东</option>
        ...
        <div class="input-container-div">
            <label class="label-style">介绍</label>：
            <textarea rows="5" cols="30" class="textarea-info"></textarea>
        </div>
        <div class="save-info-div">
            <button class="save-info">保存信息</button>
        </div>
