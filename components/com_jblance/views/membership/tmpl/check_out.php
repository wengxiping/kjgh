	...
	<?php if($type == 'plan') : ?>
		...
		<div class="well well-small jbbox-gradient">
			...
			<table style="width: 100%;">
				...
				<tr>
					...
					<td><?php echo JblanceHelper::getDaysType($this->plan->days, $this->plan->days_type); ?></td>
		...
		<div class="well well-small jbbox-gradient">
			...
			<table style="width: 100%;">
				...
				<tr>
					<td colspan="4" class="text-right"><?php echo $tax_name.' '.$this->deposit->tax_percent_dep; ?>% :</td>
					<td colspan="3" class="text-right">
						<?php
							$taxamt = ($this->deposit->tax_percent_dep / 100) * $this->deposit->amount;
							echo JblanceHelper::formatCurrency($taxamt, false);
						?>
					</td>
				</tr>
