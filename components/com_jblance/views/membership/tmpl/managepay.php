...
<form action="<?php echo $action; ?>" method="post" name="userFormJob" enctype="multipart/form-data">	
	...
	<?php echo JHtml::_('bootstrap.addTab', 'myTab', 'escrowout', JText::_('COM_JBLANCE_OUTGOING_ESCROW_PAYMENTS', true).$newTitle); ?>
	<?php 
		...
		?>
			<tr>
				...
				<td data-title="<?php echo JText::_('COM_JBLANCE_ACTION'); ?>">
					...
					<a href="javascript:modalConfirm('<?php echo JText::_('COM_JBLANCE_RELEASE', true); ?>', '<?php echo JText::_('COM_JBLANCE_CONFIRM_TO_CONTINUE', true); ?>', '<?php echo $link_release; ?>');"><?php echo JText::_('COM_JBLANCE_RELEASE'); ?></a>
	...
	//check if escrow is enabled
	if($enableEscrowPayment){ ?>
	<?php echo JHtml::_('bootstrap.addTab', 'myTab', 'escrowin', JText::_('COM_JBLANCE_INCOMING_ESCROW_PAYMENTS', true).$newTitle); ?>
	<?php
	...
	?>
			<tr>
				...
				<td data-title="<?php echo JText::_('COM_JBLANCE_ACTION'); ?>">
					...
					<a href="javascript:modalConfirm('<?php echo JText::_('COM_JBLANCE_ACCEPT', true); ?>', '<?php echo JText::_('COM_JBLANCE_CONFIRM_TO_CONTINUE', true); ?>', '<?php echo $link_accept; ?>');"><?php echo JText::_('COM_JBLANCE_ACCEPT'); ?></a>
					<?php endif; ?>
				</td>
				<td data-title="<?php echo JText::_('COM_JBLANCE_STATUS'); ?>">
	...
	<?php echo JHtml::_('bootstrap.addTab', 'myTab', 'withdrawals', JText::_('COM_JBLANCE_WITHDRAWALS', true).$newTitle); ?>	
	<?php
	...
	?>
			<tr>
				...
				<td data-title="<?php echo JText::_('COM_JBLANCE_WITHDRAWAL_FEE'); ?>" class="text-right">
					<?php  echo JblanceHelper::formatCurrency($withdraw->amount - $withdraw->finalAmount, false); ?>
				</td>
				<td data-title="<?php echo JText::_('COM_JBLANCE_STATUS'); ?>">
					<?php echo JblanceHelper::getApproveStatus($withdraw->approved); ?>
				</td>
				<td class="text-center">
					<a class="btn btn-mini jb-modal" title="<?php echo JText::_('COM_JBLANCE_PRINT_INVOICE'); ?>" href="<?php echo $link_invoice; ?>" rel="{handler: 'iframe', size: {x: 650, y: 500}}"><i class="jbf-icon-print"></i></a>
				</td>
			</tr>
	<?php
	$k = 1 - $k;
	...
	<?php echo JHtml::_('bootstrap.addTab', 'myTab', 'deposits', JText::_('COM_JBLANCE_DEPOSITS', true).$newTitle); ?>
	<?php
