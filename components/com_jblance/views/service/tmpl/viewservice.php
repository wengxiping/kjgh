...
<form action="<?php echo JRoute::_('index.php'); ?>" method="post" name="userFormProject" id="userFormProject" class="form-validate" enctype="multipart/form-data">
	...
	<div class="page-actions">
		...
		<div class="page-action">
			<a href="<?php echo $link_edit; ?>"><i class="jbf-icon-edit"></i> <?php echo JText::_('COM_JBLANCE_EDIT_SERVICE'); ?></a>
		</div>
		<?php endif; ?>
	</div>
				...
				<div class="row-fluid" style="margin-top: 15px;">
					<div class="span9">
						<?php $serviceRating = JblanceHelper::getServiceRating($row->user_id, $row->id); ?>
					 	<i class="jbf-icon-thumbs-up" title="<?php echo JText::_('COM_JBLANCE_AVERAGE_RATING'); ?>"></i> <span style="text-align: left;"><?php echo JblanceHelper::getRatingHTML($serviceRating); ?></span>
					</div>
					<div class="span3">
						<i class="jbf-icon-cart" title="<?php echo JText::_('COM_JBLANCE_SERVICES_SOLD'); ?>"></i> <?php echo $model->servicePurchaseCount($row->id); ?>
					</div>
				</div>
			</div>
			<div class="lineseparator"></div>
