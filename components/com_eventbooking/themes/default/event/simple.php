...
<div id="eb-submit-event-simple" class="<?php echo $rowFluidClass; ?> eb-container">
    <div class="eb_form_header" style="width:100%;">
        ...
        <div style="float: right; width: 50%; text-align: right;">
            <input type="submit" name="btnSave" value="<?php echo JText::_('EB_SAVE'); ?>" class="<?php echo $btnPrimary; ?>" />
            <input type="button" name="btnCancel" value="<?php echo JText::_('EB_CANCEL_EVENT'); ?>" onclick="cancelEvent();" class="<?php echo $btnPrimary; ?>" />
        </div>
    </div>
