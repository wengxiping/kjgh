...
<h1 class="contentheading"><?php echo JText::_( 'COM_MTREE_REPORT_LISTING' ) . ' - ' . $this->link->link_name; ?></h1>
...
<div id="listing">
	<form action="<?php echo JRoute::_("index.php") ?>" method="post" name="mtForm" id="mtForm" class="form-horizontal">
		...
		<div class="control-group">
			...
			<div class="controls">
				<input type="email" name="your_email" class="span8" size="40" value="<?php echo $this->user_fields_data['your_email']; ?>" />
			</div>
		</div>
		<?php } ?>
		...
		<div class="control-group">
			<div class="controls">
				<button type="button" onclick="javascript:submitbutton('send_report')" class="btn btn-primary"><?php echo JText::_( 'COM_MTREE_SEND' ) ?></button>
