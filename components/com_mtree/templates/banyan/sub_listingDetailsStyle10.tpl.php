...
<div class="row-fluid">
	<div class="span8 row-fluid">
		<div class="span3"><img src="<?php
			...
			echo $this->jconf['live_site'] . $this->mtconf['relative_path_to_listing_medium_image'] . $this->images[0]->filename;

			?>" alt="<?php echo $this->images[0]->filename; ?>" <?php
...
?>
	<div class="mt-ld-container mt-ld-main_stats">
		<?php
		foreach($config['details_view']['main_attribute'] AS $cf_id) {
