...
?>" data-link-id="<?php echo $link->link_id; ?>">
	...
	?>
	<div class="summary-view-details <?php echo ($showImageInSummary ? 'span6 mt-ls-has-image':'span8 mt-ls-no-image')?>">
		<?php
	...
	<div class="summary-view-fields <?php echo ($showImageInSummary ? 'span3':'span4')?>">
		<?php
		// Focus Field
		if( !empty($config['summary_view']['focus_field_1']) )
		{
			if( $focus1 = $link_fields->getFieldById( $config['summary_view']['focus_field_1'] ) )
			{
				?>
