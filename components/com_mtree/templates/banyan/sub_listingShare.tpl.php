		...
		<div class="row-fluid">
			<div class="span12">
				...
				if ($this->config->get('show_share_with_whatsapp')) { ?>
					<div class="listing-share-item listing-share-whatsapp"><a href="<?php
						echo 'whatsapp://send?text=';
						echo rawurlencode($share_url);
						?>" onclick="void window.open(this.href, 'win2', 'status=no,toolbar=no,scrollbars=yes,titlebar=no,menubar=no,resizable=yes,width=640,height=480,directories=no,location=no'); return false;"><i class="fa fa-whatsapp"></i></a></div>
				<?php }?>
