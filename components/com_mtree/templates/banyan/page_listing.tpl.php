<div class="mt-page-listing" itemscope itemtype="http://schema.org/<?php echo $this->config->get('schema_type'); ?>">
	<?php
	...
	if (isset($this->links) && !empty($this->links)) include $this->loadTemplate( 'sub_listings.tpl.php' );
