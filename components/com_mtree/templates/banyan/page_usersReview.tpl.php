<div class="mt-page-users-review">
		...
		<div class="review">
			...
			<div class="review-head">
				...
				<div class="review-info"><?php
					echo JText::_( 'COM_MTREE_REVIEWED_BY' ) ?><span class="review-owner"><?php echo ( ($review->user_id) ? $review->username : $review->guest_name); ?></span>, <?php echo strftime('%B %e, %Y', strtotime($review->rev_date)); ?>
				</div><?php
