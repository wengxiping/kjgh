...
<?php if( $this->task == 'listall' || $this->task == 'listmap'): ?>
...
<?php if( 
	...
	&&
	($this->hasSearchParams || $this->task == 'listall' || $this->task == 'listmap')
...
<div id="comMtFilter<?php echo $this->cat_id; ?>" class="comMtFilter"<?php echo (!$this->hasSearchParams)?' style="display:none"':''; ?>>
<?php
...
if( $this->show_avl_search )
{
	...
	echo '<div class="filterinput controls">';
	echo '<input type="text" name="avl_date_from" id="avl_date_from" value="' . htmlspecialchars($this->avl_date_from) . '">';
	echo '<input type="text" name="avl_date_to" id="avl_date_to" value="' . htmlspecialchars($this->avl_date_to) . '">';
	echo '</div>';
	echo '</div>';
	?>
...
<input type="hidden" name="task" value="<?php echo ($this->task == 'listmap') ? 'listmap' : 'listall'; ?>" />
