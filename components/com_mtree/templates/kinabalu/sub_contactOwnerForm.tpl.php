<?php
if ($this->config->get('show_contact') && $this->my->authorise('mtree.listing.contact', 'com_mtree')) {
?>
	<form id="contact-form" action="<?php echo JRoute::_('index.php'); ?>" method="post" class="form-validate form-horizontal">
		...
		<fieldset>
			...
			<div class="control-group">
				<div class="controls">
					<button class="btn btn-primary validate" type="submit"><?php echo JText::_('COM_MTREE_SEND'); ?></button>
					<?php if( $this->task != 'viewlink' ) { ?>
