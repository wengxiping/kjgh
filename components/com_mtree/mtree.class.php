...
class mtree {
	...
	function __construct() {
		...
		$this->_config->mt_search_firstname = $mt_search_firstname;
		$this->_config->mt_search_lastname = $mt_search_lastname;
		...
		$this->_config->mt_search_contactperson = $mt_search_contactperson;
		$this->_config->mt_search_mobile = $mt_search_mobile;
		$this->_config->mt_search_date = $mt_search_date;
		$this->_config->mt_search_year = $mt_search_year;
...
class mtLog {
	...
	function __construct( $database, $ip='', $user_id=0, $link_id=0, $rev_id=0 ) {
