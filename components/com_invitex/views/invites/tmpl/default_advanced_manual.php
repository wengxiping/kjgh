...
<form  method="POST" name="advanced_manualform" id="advanced_manualform">
	...
	?>
	<div class="row">
		<div id="com_invitex_repeating_block_manual0" class="com_invitex_repeating_block col-md-7 col-sm-12">
			<div class="form-inline">
				<div class="form-group">
						<input type="text" placeholder="<?php echo JText::_('INV_NAME'); ?>" value="" class="inputbox input-medium required form-control" id="invitee_name1" name="invitee_name[]">
						<input type="text" placeholder="<?php echo JText::_('INV_EMAIL'); ?>" value="" class="inputbox input-medium required form-control" id="invitee_email1" name="invitee_email[]">
				</div><!--form-group-->
			</div><!--This is a repating block of html-->
		</div>
		<div class="com_invitex_add_button col-md-4 col-sm-12">
			<div class="form-inline">
				<div class="form-group">
					<button class="btn btn-sm btn-success" type="button" id="add"	onclick="addClone_inv('com_invitex_repeating_block_manual','com_invitex_repeating_block_manual','remove_button_div_manual','glyphicon glyphicon-minus');"	title="Add">
