...
<div class="">
	<div class="invitex_black_n_white row">
		<div class="col-md-12 tabbable tabs-left inv_tabbable">
			<?php
			...
			<div class="well">
				<div class="form-group">
						<label class="control-label col-lg-2 col-md-2 col-sm-3 col-xs-12" for="guest_name" title="<?php echo JText::_('INV_GUEST_NAME');?>">
							<?php echo JText::_('INV_GUEST_NAME');?>
						</label>
						<input	type="textbox" id="guest_name" placeholder="Your name"	value='' class="form-control col-lg-2 col-md-2 col-sm-2 col-xs-12"/>
				</div>
				<div class="form-group">
						<label class="control-label col-lg-2 col-md-2 col-sm-3 col-xs-12" for="city" title="<?php echo JText::_('Enter Captcha');?>">
							<?php echo JText::_('Enter Captcha');?>
						</label>
						<div class="form-control col-lg-2 col-md-2 col-sm-2 col-xs-12">
							<?php
	  ...
	  <div id="manual" class="tab-pane" name="inv_methods" style="<?php echo ($active_tab=='manual')?'display:block':'display:none'?>">
			<form class="form-horizontal"  method="POST" name="manualform" id="manualform">
				<div class="alert alert-info"><?php echo JText::_('MANUAL_MESS') ?></div>
					...
					<div class="alert alert-danger" id="invalid_email_message" style="display:none">
			...
			<div id="oi_email" class="tab-pane" style="<?php echo ($active_tab=='oi_email')?'display:block':'display:none'?>">
				<form class="form-horizontal" method="POST" name="emailimportform" id="emailimportform">
								<fieldset>
										...
										<div class="form-group">
											   <label for="email_box" class="control-label col-lg-2 col-md-2 col-sm-3 col-xs-12"><span class="label"><?php echo JText::_('USER_ID') ?></span></label>
													<input class="inputbox form-control col-lg-2 col-md-2 col-sm-2 col-xs-12" type="text" name="email_box" id="email_box" value="">
											</div>
											<div class="form-group">
													<label for="password_box" class="control-label col-lg-2 col-md-2 col-sm-3 col-xs-12"><span class="label"><?php echo JText::_('PASS') ?></span></label>
											...
											<div class="form-group">
													<label for='provider_box' class="control-label col-lg-2 col-md-2 col-sm-3 col-xs-12"><span class="label"><?php echo JText::_('PROVIDER') ?></span></label>
			...
			<div id="oi_social" class="tab-pane" style="<?php echo ($active_tab=='oi_social')?'display:block':'display:none'?>">
				<form class="form-horizontal"  method="POST" name="socialimportform" id="socialimportform">
									<fieldset>
											...
											<div class="form-group">
															<label for="password_box" class="control-label col-lg-2 col-md-2 col-sm-3 col-xs-12"><span class="label"><?php echo JText::_('PASS') ?></sapn></label>
											...
											<div class="form-group">
														<label for='provider_box' class="control-label col-lg-2 col-md-2 col-sm-3 col-xs-12"><span class="label"><?php echo JText::_('PROVIDER') ?></span></label>
															<select name="social_provider" class='thSelect form-control col-lg-2 col-md-2 col-sm-2 col-xs-12' id="social_provider">
															<?php
															$i=1;?>
															<?php
															foreach($oi_services as $type=>$providers)
					...
					<div id="other_tools" class="tab-pane" style="<?php echo ($active_tab=='other_tools')?'display:block':'display:none'?>">
						  <form class="form-horizontal"  method="POST" name="csvform" ENCTYPE="multipart/form-data" id="csvform">
											<fieldset>
														...
														<div>
														     <label for="csvfile" class="control-label col-lg-2 col-md-2 col-sm-3 col-xs-12"><span class="label"><?php echo JText::_('UPL_CSV') ?>:</span></label>
																		<input name="csvfile" type="file" id="csvfile" class="input-file form-control col-lg-2 col-md-2 col-sm-2 col-xs-12"/>
														</div>
														<div class="invitex-form-actions">
					...
					<div id="inv_by_url" class="tab-pane" style="<?php echo ($active_tab=='inv_by_url')?'display:block':'display:none'?>">
									<form class="form-horizontal">
									    ...
									    ?>
										 <div class="form-group">
												 <label for="invite_url" class="control-label col-lg-2 col-md-2 col-sm-3 col-xs-12"><span class="label"><?php echo JText::_('INV_URL_LABLE');?>:</span></label>
													<input class="inputbox form-control col-lg-2 col-md-2 col-sm-2 col-xs-12" type="text" name="invite_url" readonly="true" value="<?php echo $invURL; ?>"/>
									  </div>
									</fieldset>
									</form>
          </div>
