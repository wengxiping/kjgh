			...
			<form role="form" action="" method="post">
				...
				if (!empty($guestInvitaion))
				{
					...
					<div class="control-group">
						...
						<div class="controls">
							<input type="text" id="quick_mod_guestinviter_name" required="required" placeholder="<?php echo JText::_('MOD_INVITE_FRIENDS_YOUR_NAME');?>" >
						</div>
					</div>
					<?php
					}
				...
				<div class="control-group">
					<div class="controls">
						<div class="invitex_email_box">
							<input type="email" class="input-large tokenfield" name="module_invitee_email" id="module_invitee_email" placeholder="<?php echo JText::_('MOD_INVITE_FRIENDS_ENTER_EMAIL');?>">
						</div>
					</div>
				...
				<div class="control-group">
					<div class="controls">
						<input type="button" id="mod_email_invite_btn"  name ="<?php echo JText::_('MOD_INVITE_FRIENDS_INVITE_SUBMIT');?>" onClick="inviteFriends()" title ="<?php echo $buttonTitle;?>" <?php if ($disable) echo 'disabled'; ?> style="<?php echo $styleBtn; ?>" class="btn-primary btn-large btn-block" value="<?php echo JText::_('MOD_INVITE_FRIENDS_INVITE_SUBMIT');?>" />
					</div>
				</div>
				<div id="consentToken">
