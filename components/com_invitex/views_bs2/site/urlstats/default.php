...
<div class="<?php echo INVITEX_WRAPPER_CLASS;?>">
	...
	<form action='' method=post name="adminForm" id="adminForm">
		...
		<table class="table-striped table-condensed table-bordered table-responsive inv_table" width="100%">
			<thead>
				<tr>
					<th class="text-left wordsbreak"><?php echo JHTML::_( 'grid.sort',  'NAMES' , 'iie.invitee_name', $listDirn, $listOrder); ?></td>
					<th class="text-left wordsbreak"><?php echo JHTML::_( 'grid.sort', 'EMAILS', 'iie.invitee_email', $listDirn, $listOrder); ?></td>
				</tr>
			</thead>
			<?php
				if($this->items)
