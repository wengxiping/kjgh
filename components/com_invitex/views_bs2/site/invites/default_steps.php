...
?>
<div class="row-fluid invitex_title_inv">
	<?php
...
if (JFactory::getApplication()->input->get('rout') != 'preview')
{
	if ($this->invitex_params->get('show_menu'))
	{
							...
							<div class="inv_step_content">
								<div class="invitex_step_heading">
									<?php
										...
										{
										?>
									<i class="icon-home inv_pointer"  onclick='window.location="<?php echo $this->invite_url?>"' title="<?php echo JText::_('BACK_TO_INVITEX');?>"></i>
									<?php
										}?>
		...
		?>
			<div class=" clearfix">
				<div class="inv_steps_parent row-fluid">
					<!--MyWizard STARTS-->
					<div id="MyWizard" class="wizard">
						<ol class="inv-steps-ol clearfix" role="tab">
							<li aria-selected="true" class="current proceed active span4" id="proceed1" >
								<span class="badge">
								<?php
									if (JFactory::getApplication()->input->get('layout') == 'send_invites')
									{
							...
							<li aria-selected="false"   id="proceed2" class="proceed span4">
								<span class="badge"><?php echo JText::_('COM_INVITEX_STEP2');?></span>
								<span class=""><?php echo JText::_('INV_FRIEND');?></span>
								<span class="chevron"></span>
								<span class="chevron"></span>
							</li>
							<li aria-selected="false" id="proceed3" class="proceed span4">
