			...
			<fieldset>
				<table>
					<tr id="additional_captcha" <?php echo $captcha_style; ?>>
						...
						<td class="mail">
							<?php echo JText::_('Captcha');?> <input type="text" id="textcaptcha" name="textcaptcha" />
				...
				<?php
					...
					$r_mail = array();
				?>
				<legend><?php echo JText::_('COM_INVITEX_IMPORTED_CONTACTS');?></legend>
				...
				<div class="tab-content">
					<div class="tab-pane active" id="all_contact">
						<div class="invitex_select_users_toinvite_header">
							...
							<div class="pull-right invitex_contacts_headder_search">
								<input type="text" id="invitex_search" class="inputbox" placeholder="<?php echo JText::_('TYPE_HERE');?>" />
							</div>
							</div>
						</div>
						<div class="invitex_select_users_toinvite_body">
							<div class="row-fluid" id="invitex_invitee_info">
								<?php
									if (!empty($contacts))
									{
									?>
										...
										{
								?>
											<div class="invitex_info span6" id="invitex_info_<?php echo $i;?>">
