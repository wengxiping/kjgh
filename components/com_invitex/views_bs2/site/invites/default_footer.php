...
<div class="<?php echo INVITEX_WRAPPER_CLASS;?>">
	<div class="invitex_footer">
		<div class="row-fluid">
			<div class="span4"><a href="<?php echo $resend_link;?>"><?php echo JText::_('RE_SEND');?></a></div>
			<div class="span4"><a href="<?php echo $stat_link;?>"><?php echo JText::_('IX_STATS');?></a></div>
			<div class="span4"><a href="<?php echo $URLstat_link;?>"><?php echo JText::_('URL_STATS');?></a></div>
		</div>
	</div>
</div>
