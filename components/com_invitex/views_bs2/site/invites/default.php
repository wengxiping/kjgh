...
<div class="<?php echo INVITEX_WRAPPER_CLASS;?>">
	...
	{
	?>
		<div class=" tabbable tabs-left inv_tabbable">
			<ul class="row-fluid nav nav-tabs inv-tabs">
				<?php
					$this->classnm = '';
					$active_tab = '';
							...
							<a data-toggle="tab">
								<div class="first_div">
									...
									switch($this->invmethod)
									{
										case'social_apis':
										case'oi_social':
												$icon_for_method = "icon-user";
												break;
										case 'sms_apis':
												$icon_for_method = "icon-envelope";
												break;
										case 'manual':
										case 'advanced_manual':
												$icon_for_method = "icon-pencil";
												break;
										case'email_apis':
										case'oi_email':
										case'js_messaging':
												...
												break;
										case'other_tools':
												$icon_for_method = "icon-folder-open";
												break;
										case'inv_by_url':
												$icon_for_method = "icon-share";
												break;
									}
									?>
									<div>
