...
<dialog>
	...
	<title><?php echo JText::_('COM_EASYSOCIAL_PAGES_DIALOG_ADD_ADMIN_TITLE'); ?></title>
	<content>
		<p><?php echo JText::sprintf('COM_EASYSOCIAL_PAGES_DIALOG_ADD_ADMIN_CONTENT', $user->getName(), $user->getName());?></p>
		<form data-promote-page-form method="post" action="<?php echo JRoute::_('index.php');?>">
			<input type="hidden" name="id" value="<?php echo $page->id;?>" />
			<input type="hidden" name="userId" value="<?php echo $user->id;?>" />
			<input type="hidden" name="controller" value="pages" />
			<input type="hidden" name="task" value="promote" />
