...
<dialog>
	...
	<title><?php echo JText::_('APP_REVIEWS_REJECT_REVIEWS'); ?></title>
	<content>
		<p><?php echo JText::_('APP_REVIEWS_REJECT_REVIEWS_DESC'); ?></p>
	...
	<buttons>
		...
		<button data-action-button type="button" class="btn btn-es-danger btn-sm"><?php echo JText::_('COM_EASYSOCIAL_REJECT_BUTTON'); ?></button>
	</buttons>
</dialog>
