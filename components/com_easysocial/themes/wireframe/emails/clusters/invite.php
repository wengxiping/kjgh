						...
						<tr>
							<td valign="top" width="100%">
								...
								<p style="color: #999999;line-height:1.5;text-align:left;margin: 0;padding: 0 0 40px;" class="stack-column">
									<?php echo JText::sprintf('COM_ES_EMAILS_FRIENDS_INVITE_CONTENT_' . strtoupper($utype), $senderName);?>
								</p>
							</td>
						</tr>
					</table>
									...
									<table align="left" style="font-size: 14px;margin: 0 auto 10px 20px; text-align:left;color:#798796" align="">
										<tr>
											<td style="padding: 5px 0;">
												<a href="<?php echo $link; ?>" style="color:#00aeef;text-decoration:none;"><?php echo JText::sprintf('COM_ES_EMAILS_BE_A_MEMBER', $siteName);?> &rarr;</a>
											</td>
										</tr>
									</table>
								</td>
