						...
						<tr>
							<td valign="top" width="100%">
								<p style="color: #999999;line-height:1.5;text-align:left;margin: 0;padding: 0 0 40px;" class="stack-column">
									<?php echo JText::sprintf('COM_ES_EMAILS_EVENT_NEW_ALBUM_CONTENT', '<a href="' . $userLink . '" style="color:#00aeef;text-decoration:underline;">' . $userName . '</a>', '<a href="' . $eventLink . '" style="color:#00aeef;text-decoration:underline;">' . $eventName . '</a>');?>
								</p>
							</td>
						</tr>
					</table>
