        ...
        <table role="presentation" aria-hidden="true" cellspacing="0" cellpadding="0" border="0" width="100%">
            <tr>
                <td style="padding: 24px; text-align: left;">
                    <h1 style="margin: 0; font-family: sans-serif; font-size: 22px; line-height: 27px; color: #666666; font-weight: normal;"><?php echo JText::sprintf('COM_EASYSOCIAL_EMAILS_EVENT_GUEST_NOTGOING_TITLE', $actor, $event); ?></h1>
                </td>
            </tr>
        </table>
    </td>
                                    ...
                                    <table align="left" style="font-size: 14px;margin: 0 auto 10px 20px; text-align:left;color:#798796" align="">
                                        <tr>
                                            <td style="padding: 5px 0;">
                                                ...
                                                <?php echo JText::sprintf('COM_EASYSOCIAL_EMAILS_EVENT_GUEST_NOTGOING_CONTENT', '<span style="color:#00aeef;">' . $actor . '</span>' , '<span style="color:#00aeef;">' . $event . '</span>' ); ?>
                                                </p>
                                            </td>
                                        </tr>
                                    </table>
