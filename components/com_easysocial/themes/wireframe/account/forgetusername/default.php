...
<div class="es-social-signon">
	<div class="es-social-signon__hd">
		<h1><?php echo JText::_('COM_EASYSOCIAL_PROFILE_REMIND_USERNAME');?></h1>
		<p><?php echo JText::_('COM_EASYSOCIAL_PROFILE_REMIND_USERNAME_DESC');?></p>
	</div>
	...
	<form class="es-social-signon__form" action="<?php echo JRoute::_('index.php');?>" method="post">
		<div class="es-social-signon__form-inner">
			...
			<div>
				<button class="btn btn-es-primary btn-block"><?php echo JText::_('COM_EASYSOCIAL_SEND_USERNAME_BUTTON');?></button>
			</div>
		</div>
