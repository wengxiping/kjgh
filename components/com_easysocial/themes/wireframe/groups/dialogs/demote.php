...
<dialog>
	...
	<content>
		<p><?php echo JText::sprintf('COM_EASYSOCIAL_GROUPS_DIALOG_REVOKE_ADMIN_CONTENT', $user->getName(), $user->getName());?></p>
		<form data-demote-group-form method="post" action="<?php echo JRoute::_('index.php');?>">
