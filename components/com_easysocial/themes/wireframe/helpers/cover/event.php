...
<div class="es-profile-header t-lg-mb--lg">
	<div class="es-profile-header__hd with-cover">
		...
		<div class="es-profile-header__avatar-wrap es-flyout" data-avatar>
			<a href="<?php echo $event->getAvatarPhoto() ? 'javascript:void(0);' : $event->getPermalink();?>"<?php echo $event->getAvatarPhoto() && $showPhotoPopup ? 'data-es-photo="' . $event->getAvatarPhoto()->id . '"' : '';?>>
