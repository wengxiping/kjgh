...
<dialog>
	...
	<title><?php echo JText::_('COM_EASYSOCIAL_EVENTS_DIALOG_CONFIRM_DEMOTE_GUEST'); ?></title>
	<content>
		<p><?php echo JText::sprintf('COM_EASYSOCIAL_EVENTS_DIALOG_CONFIRM_DEMOTE_GUEST_DESC', $user->getName());?></p>
		<form data-revoke-admin-form method="post" action="<?php echo JRoute::_('index.php');?>">
			<input type="hidden" name="id" value="<?php echo $event->id;?>" />
			<input type="hidden" name="uid" value="<?php echo $uid;?>" />
			<input type="hidden" name="controller" value="events" />
			<input type="hidden" name="task" value="demoteGuest" />
