...
<div class="es-mobile-filter">
	...
	<?php if ($cluster->canCreateNews()) { ?>
		<?php echo $this->html('mobile.filterActions',
				array(
					$this->html('mobile.filterAction', 'APP_GROUP_NEWS_NEW', ESR::apps(array('layout' => 'canvas', 'customView' => 'form', 'uid' => $cluster->getAlias(), 'type' => $cluster->getType(), 'id' => $app->getAlias())))
				)
		); ?>
	<?php } ?>
	</div>
