...
<div class="t-fs--sm t-lg-mt--lg">
	...
	data-location-provider="<?php echo $this->config->get('location.provider'); ?>">
		<a href="//maps.google.com/?q=<?php echo $location->latitude; ?>,<?php echo $location->longitude; ?>" target="_blank"><?php echo $location->getAddress(30); ?></a>
	</u>
</div>
<?php } ?>
