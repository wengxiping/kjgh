...
<div class="es-mobile-filter" data-es-mobile-filters>
	...
	<div class="es-mobile-filter__bd" data-es-group-filters>
		<?php if ($coreAlbums) { ?>
		<div class="es-mobile-filter__group<?php echo $mobileFilter != 'core' ? '' : ' is-active'; ?>" data-es-swiper-group data-type="core">
		...
		<?php if ($lib->showMyAlbums() && ($myAlbums || ($layout == 'form' && empty($id)))) { ?>
		<div class="es-mobile-filter__group<?php echo $mobileFilter != 'mine' ? '' : ' is-active'; ?>" data-es-swiper-group data-type="mine">
			<div class="es-mobile-filter-slider is-end-left" data-es-swiper-slider>
				<div class="es-mobile-filter-slider__content swiper-container" data-es-swiper-container>
					<div class="swiper-wrapper">
		...
		<?php if ($albums || ($layout == "form" && empty($id) && !$lib->showMyAlbums())) { ?>
		<div class="es-mobile-filter__group<?php echo $mobileFilter != 'regular' ? '' : ' is-active'; ?>" data-es-swiper-group data-type="regular">
			<div class="es-mobile-filter-slider is-end-left" data-es-swiper-slider>
				<div class="es-mobile-filter-slider__content swiper-container" data-es-swiper-container>
					<div class="swiper-wrapper">
