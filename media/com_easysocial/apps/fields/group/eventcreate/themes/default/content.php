...
<div>
    ...
    <div class="o-checkbox">
        ...
        <label for="eventcreate-admin"><?php echo JText::_('FIELDS_GROUP_EVENTCREATE_OPTION_ADMIN'); ?></label>
    </div>
    ...
    <div class="o-checkbox">
        ...
        <label for="eventcreate-user"><?php echo JText::_('FIELDS_GROUP_EVENTCREATE_OPTION_MEMBER'); ?></label>
    </div>
</div>
