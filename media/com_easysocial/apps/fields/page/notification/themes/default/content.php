...
<?php echo $this->html('form.popdown', 'page_notification', $value ? $value : 1, array(
		$this->html('form.popdownOption', 1, 'PLG_FIELDS_PAGE_NOTIFICATION_BOTH', 'PLG_FIELDS_PAGE_NOTIFICATION_BOTH_DESC', 'fa-globe-americas'),
		$this->html('form.popdownOption', 2, 'PLG_FIELDS_PAGE_NOTIFICATION_EMAIL', 'PLG_FIELDS_PAGE_NOTIFICATION_EMAIL_DESC', 'fa-envelope'),
