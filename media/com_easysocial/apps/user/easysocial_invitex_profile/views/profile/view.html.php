 ...
 * @since  1.0
 */
class Easysocial_Invitex_ProfileViewProfile extends SocialAppsView
{
	/**
	...
	public function display($userId)
	{
		...
		$userdata  = Foundry::user();
		$namespace = 'profile/default';
		echo parent::display($namespace);
		$link = JRoute::_($userdata->getPermalink());
		$model = $this->getModel('Easysocial_Invitex_profile');

		// Get the Invitex view
		$result = $model->getInvitexView_profile($userdata->name, $link);
	}
}
