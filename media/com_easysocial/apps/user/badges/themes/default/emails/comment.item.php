		...
		<table role="presentation" aria-hidden="true" cellspacing="0" cellpadding="0" border="0" width="100%">
			<tr>
				<td style="padding: 24px; text-align: left;">
					<h1 style="margin: 0; font-family: sans-serif; font-size: 22px; line-height: 27px; color: #666666; font-weight: normal;"><?php echo JText::_( 'APP_USER_BADGES_EMAILS_COMMENT_ITEM_CONTENT_TITLE' ); ?>></h1>
				</td>
			</tr>
		</table>
	</td>
							...
							<tr>
								...
								<td valign="top" style="padding: 0 16px;">
									<table align="left" style="font-size: 14px;margin: 0 auto 10px 20px; text-align:left;color:#798796" align="">
										...
										<tr>
											<td style="padding: 5px 0;">
												<a href="<?php echo $permalink;?>" style="color:#00aeef;text-decoration:none;"><?php echo JText::_('APP_USER_BADGES_EMAILS_COMMENT_ITEM_CONTENT_VIEW');?> &rarr;</a>
											</td>
										</tr>
									</table>
								</td>
