...
a+="Text",e.resetText||c.data("resetText",c[d]()),c[d](e[a]||this.options[a]),setTimeout(function(){"loadingText"==a?c.addClass(b).attr(b,b):c.removeClass(b).removeAttr(b)},0)},b.prototype.toggle=function(){var a=this.$element.closest('[data-pp-toggle="buttons"]'),b=!0;if(a.length){var c=this.$element.find("input");"radio"===c.prop("type")&&(c.prop("checked")&&this.$element.hasClass("active")?b=!1:a.find(".active").removeClass("active")),b&&c.prop("checked",!this.$element.hasClass("active")).trigger("change")
}b&&this.$element.toggleClass("active")};var c=a.fn.button;a.fn.button=function(c){return this.each(function(){var d=a(this),e=d.data("bs.button"),f="object"==typeof c&&c;e||d.data("bs.button",e=new b(this,f)),"toggle"==c?e.toggle():c&&e.setState(c)})},a.fn.button.Constructor=b,a.fn.button.noConflict=function(){return a.fn.button=c,this},a(document).on("click.bs.button.data-api","[data-pp-toggle^=button]",function(b){var c=a(b.target);c.hasClass("btn")||(c=c.closest(".btn")),c.button("toggle"),b.preventDefault()
...
})}(b),+function(a){"use strict";function e(){a(b).remove(),a(c).each(function(b){var c=f(a(this));c.hasClass("open")&&(c.triggerHandler(b=a.Event("hide.bs.dropdown")),b.isDefaultPrevented()||c.removeClass("open").trigger("hidden.bs.dropdown"))})}function f(b){var c=b.attr("data-target");c||(c=b.attr("href"),c=c&&/#/.test(c)&&c.replace(/.*(?=#[^\s]*$)/,""));var d=c&&a(c);return d&&d.length?d:b.parent()}var b=".dropdown-backdrop-pp",c="[data-pp-toggle=dropdown]",d=function(b){a(b).on("click.bs.dropdown",this.toggle)
};d.prototype.toggle=function(b){var c=a(this);if(!c.is(".disabled, :disabled")){var d=f(c),h=(f(c),d.hasClass("open"));if(e(),!h){if("ontouchstart"in document.documentElement&&!d.closest(".navbar-nav").length&&a('<div class="dropdown-backdrop-pp"/>').insertAfter(a(this)).on("click",e),d.triggerHandler(b=a.Event("show.bs.dropdown")),b.isDefaultPrevented())return;d.toggleClass("open").trigger("shown.bs.dropdown"),c.focus()}return!1}},d.prototype.keydown=function(b){if(/(38|40|27)/.test(b.keyCode)){var d=a(this);
if(b.preventDefault(),b.stopPropagation(),!d.is(".disabled, :disabled")){var e=f(d),g=e.hasClass("open");if(!g||g&&27==b.keyCode)return 27==b.which&&e.find(c).focus(),d.click();var h=a("[role=menu] li:not(.divider):visible a",e);if(h.length){var i=h.index(h.filter(":focus"));38==b.keyCode&&i>0&&i--,40==b.keyCode&&i<h.length-1&&i++,~i||(i=0),h.eq(i).focus()}}}};var g=a.fn.dropdown;a.fn.dropdown=function(b){return this.each(function(){var c=a(this),e=c.data("bs.dropdown");e||c.data("bs.dropdown",e=new d(this)),"string"==typeof b&&e[b].call(c)
...
};b.DEFAULTS={backdrop:!0,keyboard:!0,show:!0},b.prototype.toggle=function(a){return this[this.isShown?"hide":"show"](a)},b.prototype.show=function(b){var c=this,d=a.Event("show.bs.modal",{relatedTarget:b});this.$element.triggerHandler(d),this.isShown||d.isDefaultPrevented()||(this.isShown=!0,this.escape(),this.$element.on("click.dismiss.modal",'[data-pp-dismiss="modal"]',a.proxy(this.hide,this)),this.backdrop(function(){var d=a.support.transition&&c.$element.hasClass("fade");c.$element.parent().length||c.$element.appendTo(document.body),c.$element.show(),d&&c.$element[0].offsetWidth,c.$element.addClass("in").attr("aria-hidden",!1),c.enforceFocus();
...
},b.prototype.arrow=function(){return this.$arrow=this.$arrow||this.tip().find(".arrow")},b.prototype.tip=function(){return this.$tip||(this.$tip=a(this.options.template)),this.$tip};var c=a.fn.popover;a.fn.popover=function(c){return this.each(function(){var d=a(this),e=d.data("bs.popover"),f="object"==typeof c&&c;e||d.data("bs.popover",e=new b(this,f)),"string"==typeof c&&e[c]()})},a.fn.popover.Constructor=b,a.fn.popover.noConflict=function(){return a.fn.popover=c,this},a.fn.popoverPP=function(c){return this.each(function(){var d=a(this),e=d.data("bs.popover"),f="object"==typeof c&&c;
...
},a(window).on("load",function(){a('[data-pp-spy="affix"]').each(function(){var b=a(this),c=b.data();c.offset=c.offset||{},c.offsetBottom&&(c.offset.bottom=c.offsetBottom),c.offsetTop&&(c.offset.top=c.offsetTop),b.affix(c)})})}(b),!function(a){var b=function(b,c){if(this.$element=a(b),this.$note=a('<div class="alert"></div>'),this.options=a.extend(!0,a.fn.notify.defaults,c),this.options.transition?"fade"==this.options.transition?this.$note.addClass("in").addClass(this.options.transition):this.$note.addClass(this.options.transition):this.$note.addClass("fade").addClass("in"),this.options.type?this.$note.addClass("alert-"+this.options.type):this.$note.addClass("alert-success"),this.options.message||""===this.$element.data("message")?"object"==typeof this.options.message&&(this.options.message.html?this.$note.html(this.options.message.html):this.options.message.text?this.$note.text(this.options.message.text):this.$note.html(this.options.message)):this.$note.html(this.$element.data("message")),this.options.closable)var d=a('<a class="close pull-right" href="javascript: void(0);">&times;</a>');
return a(d).on("click",a.proxy(onClose,this)),this.$note.prepend(d),this};onClose=function(){this.options.onClose(),a(this.$note).remove(),this.options.onClosed()},b.prototype.show=function(){this.options.fadeOut.enabled&&this.$note.delay(this.options.fadeOut.delay||3e3).fadeOut("slow",a.proxy(onClose,this)),this.$element.append(this.$note),this.$note.alert()},b.prototype.hide=function(){this.options.fadeOut.enabled?this.$note.delay(this.options.fadeOut.delay||3e3).fadeOut("slow",a.proxy(onClose,this)):onClose.call(this)
},a.fn.notify=function(a){return new b(this,a)},a.fn.notify.defaults={type:"success",closable:!0,transition:"fade",fadeOut:{enabled:!0,delay:3e3},message:null,onClose:function(){},onClosed:function(){}}}(a)}(PayPlans.$),function(a){var b=function(b){var c=this,d=a.Callbacks("once memory");a.extend(this,a.Deferred(),{name:b,status:"pending",ready:function(b){b===!0&&d.fire.call(c,a),a.isFunction(b)&&d.add(b)}}),c.then(function(){c.exports=this,c.status="resolved"},function(){c.status="rejected"});var e=c.done;
c.done=function(){c.required=!0;var b=c.factory;return b&&"ready"===c.status&&b.call(c,a),c.done=e,c.done.apply(this,arguments)}};a.module=function(){var c=function(b,d){var e;if("string"==typeof b){if(e=c.get(b),void 0===d)return e;if(a.isFunction(d))return"resolved"==e.status?e:(e.factory=d,e.status="ready",e.ready("true"),e.required&&(e.status="executing",d.call(e,a)),e)}if(a.isArray(b)){var f=a.map(b,function(b){var d=c.get(a.isString(b)?b:b.name);if(d)return"pending"===d.status&&(d.status="ready"),a.isPlainObject(b)?b:void 0
});a.each(f,function(a,b){c(b.name,b.factory)})}};return a.extend(c,{registry:{},get:function(b){return b?(a.isModule(b)&&(b=b.replace("module://","")),c.registry[b]||c.create(b)):void 0},create:function(a){return c.registry[a]=new b(a)},remove:function(a){delete c.registry[a]}}),c}(),a.isModule=function(c){return"string"===a.type(c)?!!c.match("module://"):c&&c instanceof b}}(PayPlans.$),function(a){!function(){var b=function(a){this.items=a,this.start=0,this.end=a.length-1,this.node=null,this.stopped=!1};a.extend(b.prototype,{isLooping:function(){return this.stopped?!1:Math.abs(this.start-this.end)>1?(this.node=Math.floor((this.start+this.end)/2),!0):!1
},flip:function(a){a?this.end=this.node-1:this.start=this.node+1},stop:function(){this.stop=!0}}),a.Bloop=function(a){return new b(a)}}(),a.Chunk=function(b,c){a.isArray(b)&&(b=[]);var c=a.extend({},{size:256,every:1e3},c),d=a.extend(a.Deferred(),{size:c.size,every:c.every,from:0,to:b.length,process:function(a){return d.process.fn=a,d},chunkStart:function(a){return d.chunkStart.fn=a,d},chunkEnd:function(a){return d.chunkEnd.fn=a,d},start:function(){return d.stopped=!1,d.iterate(),d},iterate:function(){if(!d.stopped){var a=d.process.fn;
if(a){d.to=from.size+d.size;var c=b.length;d.to>c&&(d.to=c);var e={from:d.from,to:d.to};for(d.chunkStart.fn&&d.chunkStart.fn.call(d,e.from,e.to);d.from<d.to&&!d.stopped;)a.call(d,b[d.from]),d.from++;return d.chunkEnd.fn&&d.chunkEnd.fn.call(d,e.from,e.to),d.completed=d.from>=b.length-1,d.completed?d.resolveWith(d):d.nextIteration=setTimeout(d.iterate,d.every),d}}},pause:function(){return d.stopped=!0,clearTimeout(d.nextIteration),d},restart:function(){return"rejected"===d.state()?d:(d.from=0,d.start(),d)},stop:function(){return d.pause(),d.rejectWith(d,[d.from]),d
...
},a.uid=function(a,b){return(a?a:"")+Math.random().toString().replace(".","")+(b?b:"")}}(PayPlans.$),function(a){var b={undHash:/_|-/,colons:/::/,words:/([A-Z]+)([A-Z][a-z])/g,lowUp:/([a-z\d])([A-Z])/g,dash:/([a-z\d])([A-Z])/g,replacer:/\{([^\}]+)\}/g,dot:/\./};str=a.String=a.extend(a.String||{},{getObject:getObject=function(c,d,e){var h,i,j,f=c?c.split(b.dot):[],g=f.length,k=0;if(d=a.isArray(d)?d:[d||window],0==g)return d[0];for(;h=d[k++];){for(j=0;g-1>j&&isContainer(h);j++)h=getNext(h,f[j],e);if(isContainer(h)&&(i=getNext(h,f[j],e),void 0!==i))return e===!1&&delete h[f[j]],i
}},capitalize:function(a){return a.charAt(0).toUpperCase()+a.substr(1)},camelize:function(a){return a=str.classize(a),a.charAt(0).toLowerCase()+a.substr(1)},classize:function(a,c){for(var d=a.split(b.undHash),e=0;e<d.length;e++)d[e]=str.capitalize(d[e]);return d.join(c||"")},niceName:function(a){return str.classize(a," ")},underscore:function(a){return a.replace(b.colons,"/").replace(b.words,"$1_$2").replace(b.lowUp,"$1_$2").replace(b.dash,"_").toLowerCase()},sub:function(a,c,d){var e=[];return e.push(a.replace(b.replacer,function(a,b){var f=getObject(a,c,"boolean"==typeof d?!d:d)||getObject(b,c,"boolean"==typeof d?!d:d),g=typeof f;
return"object"!==g&&"function"!==g||null===g?""+f:(e.push(f),"")})),e.length<=1?e[0]:e},_regs:b}),a.extend(a,str)}(PayPlans.$),function(a){var b=/^\d+$/,c=/([^\[\]]+)|(\[\])/g,d=/\+/g,e=/([^?#]*)(#.*)?$/;a.String=a.extend(a.String||{},{deparam:function(a){if(!a||!e.test(a))return{};for(var h,f={},g=a.split("&"),i=0;i<g.length;i++){h=f;var j=g[i].split("=");2!=j.length&&(j=[j[0],j.slice(1).join("=")]);for(var k=decodeURIComponent(j[0].replace(d," ")),l=decodeURIComponent(j[1].replace(d," ")),m=k.match(c),n=0;n<m.length-1;n++){var o=m[n];
h[o]||(h[o]=b.test(m[n+1])||"[]"==m[n+1]?[]:{}),h=h[o]}lastPart=m[m.length-1],"[]"==lastPart?h.push(l):h[lastPart]=l}return f}})}(PayPlans.$),function(a){a.isUrl=function(a){var b=/^(http|https):\/\/(\w+:{0,1}\w*@)?(\S+)(:[0-9]+)?(\/|\/([\w#!:.?+=&%@!\-\/]))?/;return b.test(a)};var b=function(a){"use strict";var b=function(a){var c,d,e,f,g,h,b=[];if("undefined"==typeof a||null===a||""===a)return b;for(0===a.indexOf("?")&&(a=a.substring(1)),d=a.toString().split(/[&;]/),c=0;c<d.length;c++)e=d[c],f=e.split("="),g=f[0],h=-1===e.indexOf("=")?null:null===f[1]?"":f[1],b.push([g,h]);
...
},notify:function(){this.notifyWith(this,arguments)},redirect:function(a){window.location=a}}}(PayPlans.$),function(a){a.extend(PayPlans,{prefix:"payplans/",require:function(b){var c=this,b=b||{},d=a.require(b),e={};return a.each(["script","done"],function(a,b){e[b]=d[b]}),d.script=function(){var b=this,f=window.pp.rootUrl+"/media/com_payplans/scripts/",g=b.expand(arguments,{path:f}),h=a.map(g.names,function(b){if(a.isArray(b)||a.isUrl(b)||/^(\/|\.)/.test(b))return b;var d=c.prefix+b,e=a.uri(g.options.path).toPath("./"+b+".js").toString();
return[[d,e,!0]]});return e.script.apply(d,[g.options].concat(h)),d},d.done=function(a){return e.done.call(d,function(){c.ready(a)})},d},module:function(b,c){var d=this;if(!a.isArray(b)){var e=d.prefix+b;return c?a.module.apply(null,[e,function(){var b=this;c.call(b,a)}]):a.module(e)}}})}(PayPlans.$),PayPlans.module("shared/dialog",function($){var module=this;!function($){var dialogHtml='<div id="pp" class="pp-dialog"> <div class="pp-dialog-modal"> <div class="pp-dialog-header"> <div class="pp-dialog-header__grid"> <div class="pp-dialog-back-button t-hidden"><i class="fa fa-chevron-left"></i></div> <div class="pp-dialog-header__cell"><span class="pp-dialog-title"></span></div> <div class="pp-dialog-close-button"><i class="fa fa-times"></i></div> </div> </div> <div class="pp-dialog-body"> <div class="pp-dialog-container"> <div class="pp-dialog-content"></div> <div class="o-loader"></div> <div class="o-empty"> <div class="o-empty__content"><i class="o-empty__icon fa fa-exclamation-triangle"></i> <div class="o-empty__text"><span class="pp-dialog-error-message"></span></div> </div> </div> </div> </div> <div class="pp-dialog-footer"> <div class=""> <div class="pp-dialog-footer-content"></div> </div> </div> </div></div>',dialog_=".pp-dialog",dialogModal_=".pp-dialog-modal",dialogContent_=".pp-dialog-content",dialogHeader_=".pp-dialog-header",dialogFooter_=".pp-dialog-footer",dialogFooterContent_=".pp-dialog-footer-content",dialogCloseButton_=".pp-dialog-close-button",dialogTitle_=".pp-dialog-title",dialogErrorMessage_=".pp-dialog-error-message",isFailed="is-failed",isLoading="is-loading",rxBraces=/\{|\}/gi,self=PayPlans.dialog=function(a){if(void 0===a)return self;
...
b.switchClass("type-"+g),window.pp.mobile&&b.addClass("is-mobile");var h=$(dialogModal_),i=a.width,j=a.height;if($.isNumeric(j)){var k=$(dialogHeader_),l=$(dialogFooter_);j+=k.height()+l.height(),j=Math.round(j)}switch(h.css({width:i,height:j}),b.addClassAfter("active"),g){case"html":e.html(f),b.trigger("init");break;case"iframe":var m=$("<iframe>"),n=f;m.appendTo(e).one("load",function(){}).attr("src",n);break;case"deferred":return b.switchClass(isLoading),f.done(function(c){$.isPlainObject(c)?self.reopen($.extend(!0,a,c)):$.isString(c)?(a.content=c,self.reopen(a)):b.switchClass(isFailed)
...
}),{define:c.define,require:c.require}}(),d=c.require("jquery.select2");return b.fn.select2.amd=c,d}),b.resolve()}),PayPlans.require().script("shared/elements","shared/select2","shared/dialog").done(function(a){a("[data-table-grid-filter]").select2({theme:"backend",width:"resolve",minimumResultsForSearch:1/0}),PayPlans.compareVersion=function(a,b){for(var c=0,d=a.split("."),e=b.split("."),f=Math.max(d.length,e.length),g=0;f>g;g++){var h=g<d.length?parseInt(d[g],10):0,i=g<e.length?parseInt(e[g],10):0;if(isNaN(h)&&(h=0),isNaN(i)&&(i=0),h!=i){c=h>i?1:-1;
break}}return c},PayPlans.timer={show:function(a){this.editToggle(a,!0)},close:function(a){this.editToggle(a,!1)},editToggle:function(b,c){var d=a(b).closest("[data-timer-wrapper]"),e=a(d).find("[data-timer-edit-wrapper]"),f=a(d).find("[data-timer-edit-button]"),g=a(d).find("[data-timer-update-button]");c?(a(d).addClass("active"),a(e).removeClass("t-hidden"),f.addClass("t-hidden"),g.removeClass("t-hidden")):(a(d).removeClass("active"),a(e).addClass("t-hidden"),g.addClass("t-hidden"),f.removeClass("t-hidden"))
},update:function(b){var c=a(b).closest("[data-timer-wrapper]"),d=a(c).find("[data-timer-edit-wrapper]"),h=(a(c).data("key"),a(b).data("key"),a(b).val(),a(d).find('[data-timer-select][data-key="year"]').val()),i=a(d).find('[data-timer-select][data-key="month"]').val(),j=a(d).find('[data-timer-select][data-key="day"]').val(),k=a(d).find('[data-timer-select][data-key="hour"]').val(),l=a(d).find('[data-timer-select][data-key="minute"]').val(),m=a(d).find('[data-timer-select][data-key="second"]').val(),n=this.format(h,i,j,k,l,m);
a(c).find("[data-timer-hidden]").val(n),PayPlans.ajax("admin/views/support/formatTimer",{timer:n}).done(function(b){a(c).find("[data-timer-label]").val(b)})},format:function(a,b,c,d,e,f){return e||(e="0"),f||(f="0"),this.pad(a,2)+this.pad(b,2)+this.pad(c,2)+this.pad(d,2)+this.pad(e,2)+this.pad(f,2)},pad:function(a,b,c){var d=a.toString();for(c||(c="0");d.length<b;)d=c+d;return d}}}),PayPlans.ready(function(a){a(document).on("click.log.details","[data-pp-log-details]",function(){var c=a(this).data("id");PayPlans.dialog({content:PayPlans.ajax("admin/views/log/view",{id:c})})
})}),PayPlans.require().done(function(a){var b=function(){var b=a("[data-table-grid-id]:checked").length;a("[data-table-grid-box-checked]").val(b)};a(document).on("click.checkall","[data-pp-table-checkall]",function(){var c=a(this),d=c.parents("[data-table-grid]"),e=c.is(":checked");b(),d.find("[data-table-grid-id]").attr("checked",e).trigger("change")}),a(document).on("click.check","[data-table-grid] tbody > tr",function(c){var d=c.target.tagName;if("TD"==d){var e=a(this),f=e.find("[data-table-grid-id]"),g=f.is(":checked");
g?f.removeAttr("checked"):f.attr("checked",!g),b(),f.trigger("change")}}),a(document).on("change.checkbox","[data-table-grid] tbody > tr [data-table-grid-id]",function(){var d=a(this).is(":checked"),e=a(this).is(":radio"),f=a(this).parents("tr");e&&f.removeClass("is-checked"),f.toggleClass("is-checked",d),b()}),a("[data-table-grid-filter]").on("change",function(){a("[data-table-grid]").submit()}),a("[data-grid-column] [data-grid-order-up]").on("click",function(){var b=a(this).closest("tr"),c=a(b).find("input[name=cid\\[\\]]"),d=a(this),e=d.data("task");
...
return 13==b.keyCode&&""!=c.val()&&a.Joomla("submitform"),""!==c.val()?(e.removeClass("t-hidden"),d.addClass("t-hidden"),void 0):(e.addClass("t-hidden"),d.removeClass("t-hidden"),void 0)}),a(document).on("click.search","[data-table-grid-search-reset]",function(){var c=a(this),e=(a("[data-table-grid-search-submit]"),c.parents("[data-table-grid-search]").find("[data-table-grid-search-input]"));e.val(""),a.Joomla("submitform")}),PayPlans.getSelectedIds=function(){var b=[],c=a("[data-table-grid]").find("[data-table-grid-id]:checked");
return c.length<=0?b:(a(c).each(function(c,d){var e=a(d).val();b.push(e)}),b)},a("[data-table-grid-publishing]").on("click",function(){var b=a(this),c=b.data("task"),d=b.closest("tr"),e=a(d).find("input[name=cid\\[\\]]");a(e).prop("checked",!0),a("[data-table-grid-task]").val(c),a("[data-table-grid]").submit()}),a("[data-table-grid-sort]").on("click",function(){var b=a(this),c=b.data("direction"),d=b.data("sort");a("[data-table-grid-ordering]").val(d),a("[data-table-grid-direction]").val(c),a("[data-table-grid]").submit()
}),a("[data-table-grid-saveorder]").on("click",function(){var b=a(this),c=b.data("task");a("[data-pp-table-checkall]").click(),a("[data-table-grid-task]").val(c),a("[data-table-grid]").submit()})}),PayPlans.ready(function(a){a(document).on("click.timer","[data-timer-edit-button]",function(){PayPlans.timer.show(this)}),a(document).on("click.timer","[data-timer-update-button]",function(){PayPlans.timer.close(this)}),a(document).on("change.timer","[data-timer-select]",function(){PayPlans.timer.update(this)})}),PayPlans.ready(function(a){a.fn.validateForm=function(){var b=a(this),c=b.find("[data-pp-validate]"),d=!1;
return a(c).each(function(b,c){var c=a(c),e=c.find("[data-"+c.data("target")+"]"),f=e.val(),g=c.data("type");c.removeClass("has-error"),"empty"==g&&(f.length<=0||""==f)&&(c.addClass("has-error"),d=!0)}),d}});