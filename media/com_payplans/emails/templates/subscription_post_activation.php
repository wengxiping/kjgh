		...
		<table class="fontlist" id='shadow' align="center" bgcolor="#f8f8f8" border="0" cellpadding="0" cellspacing="0" width="650">
			...
			<tr>
				<td  bgcolor="f8f8f8">
					...
					We assume that you are comfortable with the services of [[CONFIG_SITE_NAME]] and the product/service is fulfilling your desire. 
					In case, you have any problem, our Support team is always available to solve the problems. <br><br>
