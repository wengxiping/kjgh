		...
		<table class="fontlist" id='shadow' align="center" bgcolor="#f8f8f8" border="0" cellpadding="0" cellspacing="0" width="650">
			...
			<tr>
				...
				<td  bgcolor="f8f8f8">
					...
					We thank you for your subscription of [[PLAN_TITLE]] at [[CONFIG_SITE_NAME]]. It is to notify that your subscription has been cancelled successfully. There will not be any more payments made for this subscription and it will automatically expire when it reaches it's expiration date <br><br>
